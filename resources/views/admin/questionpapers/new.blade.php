...
@endsection
@section('pagebc')
<li class="breadcrumb-item"><a href="{{ route('admin.questionpapers.index') }}">Manage Question Ppapers</a></li>
<li class="breadcrumb-item active">New Question Paper</li>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                    <form action="{{ route('admin.questionpapers.store') }}" method="POST" enctype='multipart/form-data'>
                        @csrf
