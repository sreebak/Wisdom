            ...
            <div class="card-body">
                    <form action="{{ route('admin.services.store') }}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="service_code" type="text" class="form-control @error('service_code') is-invalid @enderror" name="service_code" value="{{ old('service_code') }}" required autocomplete="service_code" autofocus>
                                @error('service_code')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="service_value" type="number" step="any" class="form-control   col-lg-2 col-md-2 col-sm-12  @error('service_value') is-invalid @enderror" name="service_value" value="{{ old('service_value') }}" autocomplete="service_value" autofocus>
                                @error('service_value')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
