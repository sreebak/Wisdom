            ...
            <div class="card-body">
                    <form action="{{ route('admin.blogs.store') }}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="blog_title" type="text" class="form-control @error('blog_title') is-invalid @enderror" name="blog_title" value="{{ old('blog_title') }}" required autocomplete="blog_title" autofocus>
                                @error('blog_title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="blog_date" type="date" class="form-control  col-lg-3 col-md-3 col-sm-12  @error('blog_date') is-invalid @enderror" name="blog_date" value="{{ old('blog_date') }}"  autocomplete="blog_date" autofocus>
                                @error('blog_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea id="blog_content" class="form-control @error('blog_content') is-invalid @enderror" name="blog_content" autocomplete="blog_content" autofocus>{{ old('blog_content') }}</textarea>
                                @error('blog_content')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
