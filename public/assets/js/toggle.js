...
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery"], a) } else { a(jQuery) } }(function(K) {
    ...
    K.cleanData = (function(ag) {
        return function(ah) {
            var aj, ak, ai;
            for (ai = 0;
                (ak = ah[ai]) != null; ai++) { try { aj = K._data(ak, "events"); if (aj && aj.remove) { K(ak).triggerHandler("remove") } } catch (al) {} }
            ag(ah)
        }
    })(K.cleanData);
    K.widget = function(ag, ah, ao) {
        ...
        if (K.isArray(ao)) { ao = K.extend.apply(null, [{}].concat(ao)) }
        K.expr[":"][ak.toLowerCase()] = function(ap) { return !!K.data(ap, ak) };
        K[al] = K[al] || {};
        am = K[al][ag];
        aj = K[al][ag] = function(ap, aq) { if (!this._createWidget) { return new aj(ap, aq) } if (arguments.length) { this._createWidget(ap, aq) } };
        K.extend(aj, am, { version: ao.version, _proto: K.extend({}, ao), _childConstructors: [] });
        an = new ah();
        an.options = K.widget.extend({}, an.options);
        K.each(ao, function(aq, ap) {
            if (!K.isFunction(ap)) { ai[aq] = ap; return }
            ai[aq] = (function() {
                function ar() { return ah.prototype[aq].apply(this, arguments) }

                function at(au) { return ah.prototype[aq].apply(this, au) }
                return function() {
                    var aw = this._super;
        ...
        aj.prototype = K.widget.extend(an, { widgetEventPrefix: am ? (an.widgetEventPrefix || ag) : ag }, ai, { constructor: aj, namespace: al, widgetName: ag, widgetFullName: ak });
        if (am) {
        ...
        } else { ah._childConstructors.push(aj) }
        K.widget.bridge(ag, aj);
        return aj
    };
    K.widget.extend = function(al) { var ah = M.call(arguments, 1); var ak = 0; var ag = ah.length; var ai; var aj; for (; ak < ag; ak++) { for (ai in ah[ak]) { aj = ah[ak][ai]; if (ah[ak].hasOwnProperty(ai) && aj !== undefined) { if (K.isPlainObject(aj)) { al[ai] = K.isPlainObject(al[ai]) ? K.widget.extend({}, al[ai], aj) : K.widget.extend({}, aj) } else { al[ai] = aj } } } } return al };
    K.widget.bridge = function(ah, ag) {
        ...
        K.fn[ah] = function(al) {
            ...
            var am = this;
            if (aj) {
                if (!this.length && al === "instance") { am = undefined } else {
                    this.each(function() {
                        var ao;
                        var an = K.data(this, ai);
                        if (al === "instance") { am = an; return false }
                        if (!an) { return K.error("cannot call methods on " + ah + " prior to initialization; attempted to call method '" + al + "'") }
                        if (!K.isFunction(an[al]) || al.charAt(0) === "_") { return K.error("no such method '" + al + "' for " + ah + " widget instance") }
                        ao = an[al].apply(an, ak);
                        if (ao !== an && ao !== undefined) { am = ao && ao.jquery ? am.pushStack(ao.get()) : ao; return false }
                    })
                }
            } else {
                if (ak.length) { al = K.widget.extend.apply(null, [al].concat(ak)) }
                this.each(function() { var an = K.data(this, ai); if (an) { an.option(al || {}); if (an._init) { an._init() } } else { K.data(this, ai, new ag(al, this)) } })
            }
            return am
        }
    };
    ...
    K.Widget.prototype = {
        ...
        _createWidget: function(ag, ah) {
            ...
            if (ah !== this) {
                ...
                this._on(true, this.element, { remove: function(ai) { if (ai.target === ah) { this.destroy() } } });
        ...
        destroy: function() {
            var ag = this;
            this._destroy();
            K.each(this.classesElementLookup, function(ah, ai) { ag._removeClass(ai, ah) });
        ...
        option: function(aj, ak) {
            ...
            var ai;
            var ah;
            if (arguments.length === 0) { return K.widget.extend({}, this.options) }
            if (typeof aj === "string") {
                ag = {};
                al = aj.split(".");
                aj = al.shift();
                if (al.length) {
                    ...
                    aj = al.pop();
                    if (arguments.length === 1) { return ai[aj] === undefined ? null : ai[aj] }
                    ai[aj] = ak
                } else {
                    if (arguments.length === 1) { return this.options[aj] === undefined ? null : this.options[aj] }
                    ag[aj] = ak
                }
            }
            this._setOptions(ag);
        ...
        _setOptions: function(ag) { var ah; for (ah in ag) { this._setOption(ah, ag[ah]) } return this },
        _setOption: function(ag, ah) {
            if (ag === "classes") { this._setOptionClasses(ah) }
            this.options[ag] = ah;
            if (ag === "disabled") { this._setOptionDisabled(ah) }
            return this
        },
        _setOptionClasses: function(aj) {
            ...
            for (ag in aj) {
                ...
                if (aj[ag] === this.options.classes[ag] || !ah || !ah.length) { continue }
                ai = K(ah.get());
                this._removeClass(ah, ag);
                ai.addClass(this._classes({ element: ai, keys: ag, classes: aj, add: true }))
            }
        },
        ...
        _classes: function(ag) {
            var ah = [];
            var ai = this;
            ag = K.extend({ element: this.element, classes: this.options.classes || {} }, ag);

            function aj(al, an) {
                var am, ak;
                for (ak = 0; ak < al.length; ak++) {
                    am = ai.classesElementLookup[al[ak]] || K();
                    if (ag.add) { am = K(K.uniqueSort(am.get().concat(ag.element.get()))) } else { am = K(am.not(ag.element).get()) }
                    ai.classesElementLookup[al[ak]] = am;
                    ah.push(al[ak]);
                    if (an && ag.classes[al[ak]]) { ah.push(ag.classes[al[ak]]) }
                }
            }
            this._on(ag.element, { remove: "_untrackClassesElement" });
            if (ag.keys) { aj(ag.keys.match(/\S+/g) || [], true) }
            if (ag.extra) { aj(ag.extra.match(/\S+/g) || []) }
            return ah.join(" ")
        },
        _untrackClassesElement: function(ah) {
            var ag = this;
            K.each(ag.classesElementLookup, function(ai, aj) { if (K.inArray(ah.target, aj) !== -1) { ag.classesElementLookup[ai] = K(aj.not(ah.target).get()) } })
        },
        _removeClass: function(ah, ai, ag) { return this._toggleClass(ah, ai, ag, false) },
        _addClass: function(ah, ai, ag) { return this._toggleClass(ah, ai, ag, true) },
        _toggleClass: function(aj, ak, ag, al) {
            al = (typeof al === "boolean") ? al : ag;
            var ah = (typeof aj === "string" || aj === null),
                ai = { extra: ah ? ak : ag, keys: ah ? aj : ak, element: ah ? this.element : aj, add: al };
        ...
        _on: function(aj, ai, ah) {
            ...
            K.each(ah, function(aq, ap) {
                function an() { if (!aj && (ag.options.disabled === true || K(this).hasClass("ui-state-disabled"))) { return } return (typeof ap === "string" ? ag[ap] : ap).apply(ag, arguments) }
                if (typeof ap !== "string") { an.guid = ap.guid = ap.guid || an.guid || K.guid++ }
                var ao = aq.match(/^([\w:-]*)\s*(.*)$/);
                var am = ao[1] + ag.eventNamespace;
                var al = ao[2];
                if (al) { ak.on(am, al, an) } else { ai.on(am, an) }
            })
        },
        _off: function(ah, ag) {
        ...
        _delay: function(aj, ai) {
            function ah() { return (typeof aj === "string" ? ag[aj] : aj).apply(ag, arguments) }
            var ag = this;
            return setTimeout(ah, ai || 0)
        },
        _hoverable: function(ag) {
            this.hoverable = this.hoverable.add(ag);
            this._on(ag, { mouseenter: function(ah) { this._addClass(K(ah.currentTarget), null, "ui-state-hover") }, mouseleave: function(ah) { this._removeClass(K(ah.currentTarget), null, "ui-state-hover") } })
        },
        _focusable: function(ag) {
            this.focusable = this.focusable.add(ag);
            this._on(ag, { focusin: function(ah) { this._addClass(K(ah.currentTarget), null, "ui-state-focus") }, focusout: function(ah) { this._removeClass(K(ah.currentTarget), null, "ui-state-focus") } })
        },
        _trigger: function(ag, ah, ai) {
            ...
            ak = ah.originalEvent;
            if (ak) { for (al in ak) { if (!(al in ah)) { ah[al] = ak[al] } } }
            this.element.trigger(ah, ai);
            return !(K.isFunction(aj) && aj.apply(this.element[0], [ah].concat(ai)) === false || ah.isDefaultPrevented())
        }
    };
    K.each({ show: "fadeIn", hide: "fadeOut" }, function(ah, ag) {
        K.Widget.prototype["_" + ah] = function(ak, aj, am) {
            if (typeof aj === "string") { aj = { effect: aj } }
            var al;
            var ai = !aj ? ah : aj === true || typeof aj === "number" ? ag : aj.effect || ag;
            aj = aj || {};
            if (typeof aj === "number") { aj = { duration: aj } }
            al = !K.isEmptyObject(aj);
            aj.complete = am;
            if (aj.delay) { ak.delay(aj.delay) }
            if (al && K.effects && K.effects.effect[ai]) { ak[ah](aj) } else {
                if (ai !== ah && ak[ai]) { ak[ai](aj.duration, aj.easing, am) } else {
    ...
    (function() {
        ...
        function aq(av, au, at) { return [parseFloat(av[0]) * (ah.test(av[0]) ? au / 100 : 1), parseFloat(av[1]) * (ah.test(av[1]) ? at / 100 : 1)] }

        function am(at, au) { return parseInt(K.css(at, au), 10) || 0 }

        function aj(au) { var at = au[0]; if (at.nodeType === 9) { return { width: au.width(), height: au.height(), offset: { top: 0, left: 0 } } } if (K.isWindow(at)) { return { width: au.width(), height: au.height(), offset: { top: au.scrollTop(), left: au.scrollLeft() } } } if (at.preventDefault) { return { width: 0, height: 0, offset: { top: at.pageY, left: at.pageX } } } return { width: au.outerWidth(), height: au.outerHeight(), offset: au.offset() } }
        K.position = {
            ...
            getScrollInfo: function(ax) {
                ...
                return { width: at ? K.position.scrollbarWidth() : 0, height: au ? K.position.scrollbarWidth() : 0 }
            },
            getWithinInfo: function(av) {
                var aw = K(av || window),
                    ...
                    au = !at && !ax;
                return { element: aw, isWindow: at, isDocument: ax, offset: au ? K(av).offset() : { left: 0, top: 0 }, scrollLeft: aw.scrollLeft(), scrollTop: aw.scrollTop(), width: aw.outerWidth(), height: aw.outerHeight() }
            }
        };
        K.fn.position = function(aD) {
            if (!aD || !aD.of) { return ak.apply(this, arguments) }
            aD = K.extend({}, aD);
            ...
            K.each(["my", "at"], function() {
                var aH = (aD[this] || "").split(" "),
                    aG, aF;
                if (aH.length === 1) { aH = ai.test(aH[0]) ? aH.concat(["center"]) : al.test(aH[0]) ? ["center"].concat(aH) : ["center", "center"] }
            ...
            if (aD.at[0] === "right") { ax.left += aA } else { if (aD.at[0] === "center") { ax.left += aA / 2 } }
            if (aD.at[1] === "bottom") { ax.top += ay } else { if (aD.at[1] === "center") { ax.top += ay / 2 } }
            aE = aq(av.at, aA, ay);
            ax.left += aE[0];
            ax.top += aE[1];
            return this.each(function() {
                ...
                if (aD.my[0] === "right") { aL.left -= aK } else { if (aD.my[0] === "center") { aL.left -= aK / 2 } }
                if (aD.my[1] === "bottom") { aL.top -= aH } else { if (aD.my[1] === "center") { aL.top -= aH / 2 } }
                aL.left += aM[0];
                aL.top += aM[1];
                aG = { marginLeft: aJ, marginTop: aF };
                K.each(["left", "top"], function(aR, aQ) { if (K.ui.position[aB[aR]]) { K.ui.position[aB[aR]][aQ](aL, { targetWidth: aA, targetHeight: ay, elemWidth: aK, elemHeight: aH, collisionPosition: aG, collisionWidth: aO, collisionHeight: aN, offset: [aE[0] + aM[0], aE[1] + aM[1]], my: aD.my, at: aD.at, within: aw, elem: aI }) } });
                if (aD.using) {
                    aP = function(aT) {
                        var aV = aC.left - aL.left,
                            ...
                            aU = aC.top - aL.top,
                            aR = aU + ay - aH,
                            aQ = { target: { element: az, left: aC.left, top: aC.top, width: aA, height: ay }, element: { element: aI, left: aL.left, top: aL.top, width: aK, height: aH }, horizontal: aS < 0 ? "left" : aV > 0 ? "right" : "center", vertical: aR < 0 ? "top" : aU > 0 ? "bottom" : "middle" };
                        if (aA < aK && ar(aV + aS) < aA) { aQ.horizontal = "center" }
                        if (ay < aH && ar(aU + aR) < ay) { aQ.vertical = "middle" }
                        if (ao(ar(aV), ar(aS)) > ao(ar(aU), ar(aR))) { aQ.important = "horizontal" } else { aQ.important = "vertical" }
                        aD.using.call(this, aT, aQ)
                    }
                }
                aI.offset(K.extend(aL, { using: aP }))
            })
        };
        K.ui.position = {
            fit: {
                left: function(ax, aw) {
                    ...
                    if (aw.collisionWidth > aB) {
                        if (aA > 0 && au <= 0) {
                            ...
                            ax.left += aA - at
                        } else { if (au > 0 && aA <= 0) { ax.left = az } else { if (aA > au) { ax.left = az + aB - aw.collisionWidth } else { ax.left = az } } }
                    } else { if (aA > 0) { ax.left += aA } else { if (au > 0) { ax.left -= au } else { ax.left = ao(ax.left - ay, ax.left) } } }
                },
                top: function(aw, av) {
                    var au = av.within,
                    ...
                    if (av.collisionHeight > aB) {
                        if (az > 0 && ax <= 0) {
                            ...
                            aw.top += az - at
                        } else { if (ax > 0 && az <= 0) { aw.top = aA } else { if (az > ax) { aw.top = aA + aB - av.collisionHeight } else { aw.top = aA } } }
                    } else { if (az > 0) { aw.top += az } else { if (ax > 0) { aw.top -= ax } else { aw.top = ao(aw.top - ay, aw.top) } } }
                }
            },
            flip: {
                left: function(az, ay) {
                    var ax = ay.within,
                        ...
                        aw = -2 * ay.offset[0],
                        at, aB;
                    if (aE < 0) { at = az.left + aC + aF + aw + ay.collisionWidth - aG - aD; if (at < 0 || at < ar(aE)) { az.left += aC + aF + aw } } else { if (au > 0) { aB = az.left - ay.collisionPosition.marginLeft + aC + aF + aw - av; if (aB > 0 || ar(aB) < au) { az.left += aC + aF + aw } } }
                },
                top: function(ay, ax) {
                    var aw = ax.within,
                        ...
                        av = -2 * ax.offset[1],
                        aE, au;
                    if (aC < 0) { au = ay.top + aB + aH + av + ax.collisionHeight - aG - aF; if (au < 0 || au < ar(aC)) { ay.top += aB + aH + av } } else { if (az > 0) { aE = ay.top - ax.collisionPosition.marginTop + aB + aH + av - at; if (aE > 0 || ar(aE) < az) { ay.top += aB + aH + av } } }
                }
            },
            flipfit: {
                left: function() {
    ...
    K.ui.focusable = function(aj, ah) {
        ...
        if ("area" === an) {
            am = aj.parentNode;
            ak = am.name;
            if (!aj.href || !ak || am.nodeName.toLowerCase() !== "map") { return false }
            ai = K("img[usemap='#" + ak + "']");
            return ai.length > 0 && ai.is(":visible")
        }
        if (/^(input|select|textarea|button|object)$/.test(an)) { al = !aj.disabled; if (al) { ag = K(aj).closest("fieldset")[0]; if (ag) { al = !ag.disabled } } } else { if ("a" === an) { al = aj.href || ah } else { al = ah } }
    ...
    K.extend(K.expr[":"], { focusable: function(ag) { return K.ui.focusable(ag, K.attr(ag, "tabindex") != null) } });
    var B = K.ui.focusable;
    var P = K.fn.form = function() { return typeof this[0].form === "string" ? this.closest("form") : K(this[0].form) };
    /*!
    ...
    var i = K.ui.formResetMixin = {
        _formResetHandler: function() {
            ...
            setTimeout(function() {
                ...
                K.each(ah, function() { this.refresh() })
            })
        },
        _bindFormResetHandler: function() {
            ...
            if (!ag.length) { this.form.on("reset.ui-form-reset", this._formResetHandler) }
            ag.push(this);
        ...
        _unbindFormResetHandler: function() {
            ...
            if (ag.length) { this.form.data("ui-form-reset-instances", ag) } else { this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset") }
        }
    };
    /*!
     ...
     * http://jquery.org/license
     */
    var w = K.ui.keyCode = { BACKSPACE: 8, COMMA: 188, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, LEFT: 37, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SPACE: 32, TAB: 9, UP: 38 };
    var Y = K.ui.escapeSelector = (function() { var ag = /([!"#$%&'()*+,./:;<=>?@[\]^`{|}~])/g; return function(ah) { return ah.replace(ag, "\\$1") } })();
    /*!
    ...
    var J = K.fn.scrollParent = function(ai) {
        var ah = this.css("position"),
            ...
            ak = this.parents().filter(function() { var al = K(this); if (ag && al.css("position") === "static") { return false } return aj.test(al.css("overflow") + al.css("overflow-y") + al.css("overflow-x")) }).eq(0);
     ...
     * http://jquery.org/license
     */
    var k = K.fn.extend({ uniqueId: (function() { var ag = 0; return function() { return this.each(function() { if (!this.id) { this.id = "ui-id-" + (++ag) } }) } })(), removeUniqueId: function() { return this.each(function() { if (/^ui-id-\d+$/.test(this.id)) { K(this).removeAttr("id") } }) } });
     ...
     */
    var e = false;
    K(document).on("mouseup", function() { e = false });
    var H = K.widget("ui.mouse", {
        version: "1.12.1",
        options: { cancel: "input, textarea, button, select, option", distance: 1, delay: 0 },
        _mouseInit: function() {
            var ag = this;
            this.element.on("mousedown." + this.widgetName, function(ah) { return ag._mouseDown(ah) }).on("click." + this.widgetName, function(ah) {
        ...
        _mouseDown: function(ai) {
            ...
            if (!aj || ag || !this._mouseCapture(ai)) { return true }
            this.mouseDelayMet = !this.options.delay;
            if (!this.mouseDelayMet) { this._mouseDelayTimer = setTimeout(function() { ah.mouseDelayMet = true }, this.options.delay) }
            if (this._mouseDistanceMet(ai) && this._mouseDelayMet(ai)) { this._mouseStarted = (this._mouseStart(ai) !== false); if (!this._mouseStarted) { ai.preventDefault(); return true } }
            if (true === K.data(ai.target, this.widgetName + ".preventClickEvent")) { K.removeData(ai.target, this.widgetName + ".preventClickEvent") }
            this._mouseMoveDelegate = function(ak) { return ah._mouseMove(ak) };
            this._mouseUpDelegate = function(ak) { return ah._mouseUp(ak) };
        ...
        _mouseMove: function(ag) {
            if (this._mouseMoved) { if (K.ui.ie && (!document.documentMode || document.documentMode < 9) && !ag.button) { return this._mouseUp(ag) } else { if (!ag.which) { if (ag.originalEvent.altKey || ag.originalEvent.ctrlKey || ag.originalEvent.metaKey || ag.originalEvent.shiftKey) { this.ignoreMissingWhich = true } else { if (!this.ignoreMissingWhich) { return this._mouseUp(ag) } } } } }
            if (ag.which || ag.button) { this._mouseMoved = true }
            if (this._mouseStarted) { this._mouseDrag(ag); return ag.preventDefault() }
        ...
        _mouseUp: function(ag) {
            ...
            if (this._mouseStarted) {
                ...
                if (ag.target === this._mouseDownEvent.target) { K.data(ag.target, this.widgetName + ".preventClickEvent", true) }
                this._mouseStop(ag)
            }
        ...
        _mouseDistanceMet: function(ag) { return (Math.max(Math.abs(this._mouseDownEvent.pageX - ag.pageX), Math.abs(this._mouseDownEvent.pageY - ag.pageY)) >= this.options.distance) },
    ...
    var ab = K.ui.plugin = {
        ...
        call: function(ag, aj, ai, ah) { var ak, al = ag.plugins[aj]; if (!al) { return } if (!ah && (!ag.element[0].parentNode || ag.element[0].parentNode.nodeType === 11)) { return } for (ak = 0; ak < al.length; ak++) { if (ag.options[al[ak][0]]) { al[ak][1].apply(ag.element, ai) } } }
    };
    var O = K.ui.safeActiveElement = function(ag) { var ai; try { ai = ag.activeElement } catch (ah) { ai = ag.body } if (!ai) { ai = ag.body } if (!ai.nodeName) { ai = ag.body } return ai };
    var z = K.ui.safeBlur = function(ag) { if (ag && ag.nodeName.toLowerCase() !== "body") { K(ag).trigger("blur") } };
    /*!
    ...
    K.widget("ui.draggable", K.ui.mouse, {
        ...
        _mouseCapture: function(ag) {
            var ah = this.options;
            if (this.helper || ah.disabled || K(ag.target).closest(".ui-resizable-handle").length > 0) { return false }
        ...
        _blockFrames: function(ag) { this.iframeBlocks = this.document.find(ag).map(function() { var ah = K(this); return K("<div>").css("position", "absolute").appendTo(ah.parent()).outerWidth(ah.outerWidth()).outerHeight(ah.outerHeight()).offset(ah.offset())[0] }) },
        ...
        _blurActiveElement: function(ah) {
            var ag = K.ui.safeActiveElement(this.document[0]),
                ai = K(ah.target);
            if (ai.closest(ag).length) { return }
            K.ui.safeBlur(ag)
        },
        _mouseStart: function(ag) {
            ...
            if (K.ui.ddmanager) { K.ui.ddmanager.current = this }
            this._cacheMargins();
            this.cssPosition = this.helper.css("position");
            this.scrollParent = this.helper.scrollParent(true);
            this.offsetParent = this.helper.offsetParent();
            this.hasFixedAncestor = this.helper.parents().filter(function() { return K(this).css("position") === "fixed" }).length > 0;
            ...
            if (this._trigger("start", ag) === false) { this._clear(); return false }
            this._cacheHelperProportions();
            if (K.ui.ddmanager && !ah.dropBehaviour) { K.ui.ddmanager.prepareOffsets(this, ag) }
            this._mouseDrag(ag, true);
            if (K.ui.ddmanager) { K.ui.ddmanager.dragStart(this, ag) }
            return true
        },
        _refreshOffsets: function(ag) {
            ...
            this.offset.click = { left: ag.pageX - this.offset.left, top: ag.pageY - this.offset.top }
        },
        _mouseDrag: function(ag, ai) {
            ...
            if (!ai) {
                var ah = this._uiHash();
                if (this._trigger("drag", ag, ah) === false) { this._mouseUp(new K.Event("mouseup", ag)); return false }
                this.position = ah.position
            }
            this.helper[0].style.left = this.position.left + "px";
            this.helper[0].style.top = this.position.top + "px";
            if (K.ui.ddmanager) { K.ui.ddmanager.drag(this, ag) }
            return false
        },
        _mouseStop: function(ah) {
            var ag = this,
                ai = false;
            if (K.ui.ddmanager && !this.options.dropBehaviour) { ai = K.ui.ddmanager.drop(this, ah) }
            if (this.dropped) {
                ai = this.dropped;
                this.dropped = false
            }
            if ((this.options.revert === "invalid" && !ai) || (this.options.revert === "valid" && ai) || this.options.revert === true || (K.isFunction(this.options.revert) && this.options.revert.call(this.element, ai))) { K(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() { if (ag._trigger("stop", ah) !== false) { ag._clear() } }) } else { if (this._trigger("stop", ah) !== false) { this._clear() } }
            return false
        },
        _mouseUp: function(ag) { this._unblockFrames(); if (K.ui.ddmanager) { K.ui.ddmanager.dragStop(this, ag) } if (this.handleElement.is(ag.target)) { this.element.trigger("focus") } return K.ui.mouse.prototype._mouseUp.call(this, ag) },
        cancel: function() { if (this.helper.is(".ui-draggable-dragging")) { this._mouseUp(new K.Event("mouseup", { target: this.element[0] })) } else { this._clear() } return this },
        _getHandle: function(ag) { return this.options.handle ? !!K(ag.target).closest(this.element.find(this.options.handle)).length : true },
        ...
        _createHelper: function(ah) {
            ...
            if (!ag.parents("body").length) { ag.appendTo((aj.appendTo === "parent" ? this.element[0].parentNode : aj.appendTo)) }
            if (ai && ag[0] === this.element[0]) { this._setPositionRelative() }
            if (ag[0] !== this.element[0] && !(/(fixed|absolute)/).test(ag.css("position"))) { ag.css("position", "absolute") }
            return ag
        },
        _setPositionRelative: function() { if (!(/^(?:r|a|f)/).test(this.element.css("position"))) { this.element[0].style.position = "relative" } },
        _adjustOffsetFromHelper: function(ag) { if (typeof ag === "string") { ag = ag.split(" ") } if (K.isArray(ag)) { ag = { left: +ag[0], top: +ag[1] || 0 } } if ("left" in ag) { this.offset.click.left = ag.left + this.margins.left } if ("right" in ag) { this.offset.click.left = this.helperProportions.width - ag.right + this.margins.left } if ("top" in ag) { this.offset.click.top = ag.top + this.margins.top } if ("bottom" in ag) { this.offset.click.top = this.helperProportions.height - ag.bottom + this.margins.top } },
        _isRootNode: function(ag) { return (/(html|body)/i).test(ag.tagName) || ag === this.document[0] },
        _getParentOffset: function() {
            ...
            if (this._isRootNode(this.offsetParent[0])) { ah = { top: 0, left: 0 } }
            return { top: ah.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0), left: ah.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0) }
        },
        _getRelativeOffset: function() {
            if (this.cssPosition !== "relative") { return { top: 0, left: 0 } }
            var ag = this.element.position(),
                ah = this._isRootNode(this.scrollParent[0]);
            return { top: ag.top - (parseInt(this.helper.css("top"), 10) || 0) + (!ah ? this.scrollParent.scrollTop() : 0), left: ag.left - (parseInt(this.helper.css("left"), 10) || 0) + (!ah ? this.scrollParent.scrollLeft() : 0) }
        },
        ...
        _setContainment: function() {
            ...
            if (!aj.containment) { this.containment = null; return }
            ...
            if (aj.containment === "document") { this.containment = [0, 0, K(ag).width() - this.helperProportions.width - this.margins.left, (K(ag).height() || ag.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]; return }
            if (aj.containment.constructor === Array) { this.containment = aj.containment; return }
            if (aj.containment === "parent") { aj.containment = this.helper[0].parentNode }
            ak = K(aj.containment);
            ai = ak[0];
            if (!ai) { return }
        ...
        _convertPositionTo: function(ah, aj) {
            if (!aj) { aj = this.position }
            var ag = ah === "absolute" ? 1 : -1,
                ai = this._isRootNode(this.scrollParent[0]);
            return { top: (aj.top + this.offset.relative.top * ag + this.offset.parent.top * ag - ((this.cssPosition === "fixed" ? -this.offset.scroll.top : (ai ? 0 : this.offset.scroll.top)) * ag)), left: (aj.left + this.offset.relative.left * ag + this.offset.parent.left * ag - ((this.cssPosition === "fixed" ? -this.offset.scroll.left : (ai ? 0 : this.offset.scroll.left)) * ag)) }
        },
        _generatePosition: function(ah, an) {
            var ag, ao, ap, aj, ai = this.options,
                ...
                al = ah.pageX,
                ak = ah.pageY;
            if (!am || !this.offset.scroll) { this.offset.scroll = { top: this.scrollParent.scrollTop(), left: this.scrollParent.scrollLeft() } }
            if (an) {
                if (this.containment) {
                    ...
                    } else { ag = this.containment }
                    if (ah.pageX - this.offset.click.left < ag[0]) { al = ag[0] + this.offset.click.left }
                    if (ah.pageY - this.offset.click.top < ag[1]) { ak = ag[1] + this.offset.click.top }
                    if (ah.pageX - this.offset.click.left > ag[2]) { al = ag[2] + this.offset.click.left }
                    if (ah.pageY - this.offset.click.top > ag[3]) { ak = ag[3] + this.offset.click.top }
                }
                if (ai.grid) {
                ...
                if (ai.axis === "y") { al = this.originalPageX }
                if (ai.axis === "x") { ak = this.originalPageY }
            }
            return { top: (ak - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (this.cssPosition === "fixed" ? -this.offset.scroll.top : (am ? 0 : this.offset.scroll.top))), left: (al - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (this.cssPosition === "fixed" ? -this.offset.scroll.left : (am ? 0 : this.offset.scroll.left))) }
        },
        _clear: function() {
    ...
    K.ui.plugin.add("draggable", "connectToSortable", {
        start: function(ai, aj, ag) {
            var ah = K.extend({}, aj, { item: ag.element });
            ag.sortables = [];
        ...
        stop: function(ai, aj, ag) {
            ...
            K.each(ag.sortables, function() {
                ...
                if (ak.isOver) {
                    ...
                    ak._storedCSS = { position: ak.placeholder.css("position"), top: ak.placeholder.css("top"), left: ak.placeholder.css("left") };
                    ak._mouseStop(ai);
            ...
            K.each(ag.sortables, function() {
                ...
                if (ak._intersectsWith(ak.containerCache)) {
                    ...
                    K.each(ag.sortables, function() {
                        ...
                        if (this !== ak && this._intersectsWith(this.containerCache) && K.contains(ak.element[0], this.element[0])) { aj = false }
                        return aj
                    })
                }
                if (aj) {
                    if (!ak.isOver) {
                        ...
                        ak.options.helper = function() { return ai.helper[0] };
                        ...
                        K.each(ag.sortables, function() { this.refreshPositions() });
                    ...
                    if (ak.isOver) {
                        ...
                        ak.options.helper = ak.options._helper;
                        if (ak.placeholder) { ak.placeholder.remove() }
    ...
    K.ui.plugin.add("draggable", "snap", {
        start: function(ah, ai, ag) {
            ...
            K(aj.snap.constructor !== String ? (aj.snap.items || ":data(ui-draggable)") : aj.snap).each(function() {
                var al = K(this),
                    ak = al.offset();
                if (this !== ag.element[0]) { ag.snapElements.push({ item: this, width: al.outerWidth(), height: al.outerHeight(), top: ak.top, left: ak.left }) }
            })
        },
            ...
            for (au = aj.snapElements.length - 1; au >= 0; au--) {
                ...
                if (av < ar - ax || aw > ao + ax || ah < an - ax || ai > az + ax || !K.contains(aj.snapElements[au].item.ownerDocument, aj.snapElements[au].item)) {
                    if (aj.snapElements[au].snapping) {
                        (aj.options.snap.release && aj.options.snap.release.call(aj.element, at, K.extend(aj._uiHash(), { snapItem: aj.snapElements[au].item })))
                    }
                ...
                if (aq.snapMode !== "inner") {
                    ...
                    if (ag) { ap.position.top = aj._convertPositionTo("relative", { top: an - aj.helperProportions.height, left: 0 }).top }
                    if (ay) { ap.position.top = aj._convertPositionTo("relative", { top: az, left: 0 }).top }
                    if (al) { ap.position.left = aj._convertPositionTo("relative", { top: 0, left: ar - aj.helperProportions.width }).left }
                    if (am) { ap.position.left = aj._convertPositionTo("relative", { top: 0, left: ao }).left }
                }
                ak = (ag || ay || al || am);
                if (aq.snapMode !== "outer") {
                    ...
                    if (ag) { ap.position.top = aj._convertPositionTo("relative", { top: an, left: 0 }).top }
                    if (ay) { ap.position.top = aj._convertPositionTo("relative", { top: az - aj.helperProportions.height, left: 0 }).top }
                    if (al) { ap.position.left = aj._convertPositionTo("relative", { top: 0, left: ar }).left }
                    if (am) { ap.position.left = aj._convertPositionTo("relative", { top: 0, left: ao - aj.helperProportions.width }).left }
                }
                if (!aj.snapElements[au].snapping && (ag || ay || al || am || ak)) {
                    (aj.options.snap.snap && aj.options.snap.snap.call(aj.element, at, K.extend(aj._uiHash(), { snapItem: aj.snapElements[au].item })))
                }
    ...
    K.ui.plugin.add("draggable", "stack", {
        start: function(ai, aj, ag) {
            var ah, al = ag.options,
                ak = K.makeArray(K(al.stack)).sort(function(an, am) { return (parseInt(K(an).css("zIndex"), 10) || 0) - (parseInt(K(am).css("zIndex"), 10) || 0) });
            if (!ak.length) { return }
            ah = parseInt(K(ak[0]).css("zIndex"), 10) || 0;
            K(ak).each(function(am) { K(this).css("zIndex", ah + am) });
    ...
    K.ui.plugin.add("draggable", "zIndex", {
        start: function(ai, aj, ag) {
            var ah = K(aj.helper),
                ak = ag.options;
            if (ah.css("zIndex")) { ak._zIndex = ah.css("zIndex") }
            ah.css("zIndex", ak.zIndex)
        },
        stop: function(ah, ai, ag) { var aj = ag.options; if (aj._zIndex) { K(ai.helper).css("zIndex", aj._zIndex) } }
    });
    ...
    K.widget("ui.droppable", {
        ...
        _create: function() {
            ...
            this.isover = false;
            this.isout = true;
            this.accept = K.isFunction(ag) ? ag : function(aj) { return aj.is(ag) };
            this.proportions = function() { if (arguments.length) { ah = arguments[0] } else { return ah ? ah : ah = { width: this.element[0].offsetWidth, height: this.element[0].offsetHeight } } };
        ...
        _splice: function(ag) { var ah = 0; for (; ah < ag.length; ah++) { if (ag[ah] === this) { ag.splice(ah, 1) } } },
        _destroy: function() {
            var ag = K.ui.ddmanager.droppables[this.options.scope];
            this._splice(ag)
        },
        _setOption: function(ah, ai) {
            if (ah === "accept") { this.accept = K.isFunction(ai) ? ai : function(aj) { return aj.is(ai) } } else {
                if (ah === "scope") {
                    var ag = K.ui.ddmanager.droppables[this.options.scope];
                    this._splice(ag);
        ...
        _activate: function(ah) {
            ...
            if (ag) { this._trigger("activate", ah, this.ui(ag)) }
        },
        _deactivate: function(ah) {
            var ag = K.ui.ddmanager.current;
            this._removeActiveClass();
            if (ag) { this._trigger("deactivate", ah, this.ui(ag)) }
        },
        _over: function(ah) {
            var ag = K.ui.ddmanager.current;
            if (!ag || (ag.currentItem || ag.element)[0] === this.element[0]) { return }
        ...
        _drop: function(ah, ai) {
            var ag = ai || K.ui.ddmanager.current,
                aj = false;
            if (!ag || (ag.currentItem || ag.element)[0] === this.element[0]) { return false }
            this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() { var ak = K(this).droppable("instance"); if (ak.options.greedy && !ak.options.disabled && ak.options.scope === ag.options.scope && ak.accept.call(ak.element[0], (ag.currentItem || ag.element)) && I(ag, K.extend(ak, { offset: ak.element.offset() }), ak.options.tolerance, ah)) { aj = true; return false } });
            if (aj) { return false }
            if (this.accept.call(this.element[0], (ag.currentItem || ag.element))) {
                this._removeActiveClass();
                this._removeHoverClass();
        ...
        ui: function(ag) { return { draggable: (ag.currentItem || ag.element), helper: ag.helper, position: ag.position, offset: ag.positionAbs } },
    ...
    var I = K.ui.intersect = (function() {
        function ag(ai, ah, aj) { return (ai >= ah) && (ai < (ah + aj)) }
    ...
    K.ui.ddmanager = {
        ...
        prepareOffsets: function(aj, al) {
            ...
            droppablesLoop: for (ai = 0; ai < ag.length; ai++) {
                if (ag[ai].options.disabled || (aj && !ag[ai].accept.call(ag[ai].element[0], (aj.currentItem || aj.element)))) { continue }
                for (ah = 0; ah < am.length; ah++) { if (am[ah] === ag[ai].element[0]) { ag[ai].proportions().height = 0; continue droppablesLoop } }
                ag[ai].visible = ag[ai].element.css("display") !== "none";
                if (!ag[ai].visible) { continue }
                if (ak === "mousedown") { ag[ai]._activate.call(ag[ai], al) }
                ag[ai].offset = ag[ai].element.offset();
                ag[ai].proportions({ width: ag[ai].element[0].offsetWidth, height: ag[ai].element[0].offsetHeight })
            }
        },
        drop: function(ag, ah) {
            var ai = false;
            K.each((K.ui.ddmanager.droppables[ag.options.scope] || []).slice(), function() {
                ...
                if (!this.options.disabled && this.visible && I(ag, this, this.options.tolerance, ah)) { ai = this._drop.call(this, ah) || ai }
        ...
        dragStart: function(ag, ah) { ag.element.parentsUntil("body").on("scroll.droppable", function() { if (!ag.options.refreshPositions) { K.ui.ddmanager.prepareOffsets(ag, ah) } }) },
        drag: function(ag, ah) {
            if (ag.options.refreshPositions) { K.ui.ddmanager.prepareOffsets(ag, ah) }
            K.each(K.ui.ddmanager.droppables[ag.options.scope] || [], function() {
                ...
                if (this.options.greedy) {
                    ...
                    ai = this.element.parents(":data(ui-droppable)").filter(function() { return K(this).droppable("instance").options.scope === aj });
                    if (ai.length) {
        ...
        dragStop: function(ag, ah) { ag.element.parentsUntil("body").off("scroll.droppable"); if (!ag.options.refreshPositions) { K.ui.ddmanager.prepareOffsets(ag, ah) } }
    };
    ...
    K.widget("ui.resizable", K.ui.mouse, {
        ...
        _num: function(ag) { return parseFloat(ag) || 0 },
        _isNumber: function(ag) { return !isNaN(parseFloat(ag)) },
        _hasScroll: function(aj, ah) {
            if (K(aj).css("overflow") === "hidden") { return false }
            var ag = (ah && ah === "left") ? "scrollLeft" : "scrollTop",
                ai = false;
            if (aj[ag] > 0) { return true }
            aj[ag] = 1;
            ai = (aj[ag] > 0);
            aj[ag] = 0;
            return ai
        ...
        _create: function() {
            ...
            K.extend(this, { _aspectRatio: !!(ai.aspectRatio), aspectRatio: ai.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: ai.helper || ai.ghost || ai.animate ? ai.helper || "ui-resizable-helper" : null });
            if (this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i)) {
                this.element.wrap(K("<div class='ui-wrapper' style='overflow: hidden;'></div>").css({ position: this.element.css("position"), width: this.element.outerWidth(), height: this.element.outerHeight(), top: this.element.css("top"), left: this.element.css("left") }));
                this.element = this.element.parent().data("ui-resizable", this.element.resizable("instance"));
                this.elementIsWrapper = true;
                ah = { marginTop: this.originalElement.css("marginTop"), marginRight: this.originalElement.css("marginRight"), marginBottom: this.originalElement.css("marginBottom"), marginLeft: this.originalElement.css("marginLeft") };
                this.element.css(ah);
        ...
        _destroy: function() {
            this._mouseDestroy();
            var ah, ag = function(ai) { K(ai).removeData("resizable").removeData("ui-resizable").off(".resizable").find(".ui-resizable-handle").remove() };
            if (this.elementIsWrapper) {
                ag(this.element);
                ah = this.element;
                this.originalElement.css({ position: ah.css("position"), width: ah.outerWidth(), height: ah.outerHeight(), top: ah.css("top"), left: ah.css("left") }).insertAfter(ah);
                ah.remove()
            }
        ...
        _setupHandles: function() {
            ...
            this.handles = al.handles || (!K(".ui-resizable-handle", this.element).length ? "e,s,se" : { n: ".ui-resizable-n", e: ".ui-resizable-e", s: ".ui-resizable-s", w: ".ui-resizable-w", se: ".ui-resizable-se", sw: ".ui-resizable-sw", ne: ".ui-resizable-ne", nw: ".ui-resizable-nw" });
            this._handles = K();
            ...
            this._renderAxis = function(ar) {
                ...
                for (ao in this.handles) {
                    if (this.handles[ao].constructor === String) { this.handles[ao] = this.element.children(this.handles[ao]).first().show() } else {
                        if (this.handles[ao].jquery || this.handles[ao].nodeType) {
                            this.handles[ao] = K(this.handles[ao]);
                            this._on(this.handles[ao], { mousedown: aj._mouseDown })
                        }
                    }
            ...
            this._handles.on("mouseover", function() {
                if (!aj.resizing) {
                    if (this.className) { ai = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i) }
        ...
        _mouseCapture: function(ai) { var ah, aj, ag = false; for (ah in this.handles) { aj = K(this.handles[ah])[0]; if (aj === ai.target || K.contains(aj, ai.target)) { ag = true } } return !this.options.disabled && ag },
        _mouseStart: function(ah) {
            ...
            this.position = { left: al, top: ai };
            this.size = this._helper ? { width: this.helper.width(), height: this.helper.height() } : { width: ag.width(), height: ag.height() };
            this.originalSize = this._helper ? { width: ag.outerWidth(), height: ag.outerHeight() } : { width: ag.width(), height: ag.height() };
            this.sizeDiff = { width: ag.outerWidth() - ag.width(), height: ag.outerHeight() - ag.height() };
            this.originalPosition = { left: al, top: ai };
            this.originalMousePosition = { left: ah.pageX, top: ah.pageY };
        ...
        _mouseDrag: function(al) {
            ...
            if (this._aspectRatio || al.shiftKey) { am = this._updateRatio(am, al) }
        ...
        _mouseStop: function(aj) {
            ...
            if (this._helper) {
                ...
                ap = { width: (an.helper.width() - am), height: (an.helper.height() - ah) };
                ...
                if (!ak.animate) { this.element.css(K.extend(ap, { top: ao, left: al })) }
                an.helper.height(an.size.height);
                an.helper.width(an.size.width);
                if (this._helper && !ak.animate) { this._proportionallyResize() }
            }
        ...
        _applyChanges: function() {
            var ag = {};
            if (this.position.top !== this.prevPosition.top) { ag.top = this.position.top + "px" }
            if (this.position.left !== this.prevPosition.left) { ag.left = this.position.left + "px" }
            if (this.size.width !== this.prevSize.width) { ag.width = this.size.width + "px" }
            if (this.size.height !== this.prevSize.height) { ag.height = this.size.height + "px" }
            this.helper.css(ag);
            return ag
        },
        _updateVirtualBoundaries: function(ai) {
            var ak, aj, ah, am, ag, al = this.options;
            ag = { minWidth: this._isNumber(al.minWidth) ? al.minWidth : 0, maxWidth: this._isNumber(al.maxWidth) ? al.maxWidth : Infinity, minHeight: this._isNumber(al.minHeight) ? al.minHeight : 0, maxHeight: this._isNumber(al.maxHeight) ? al.maxHeight : Infinity };
            if (this._aspectRatio || ai) {
                ...
                if (ak > ag.minWidth) { ag.minWidth = ak }
                if (ah > ag.minHeight) { ag.minHeight = ah }
                if (aj < ag.maxWidth) { ag.maxWidth = aj }
                if (am < ag.maxHeight) { ag.maxHeight = am }
            }
            this._vBoundaries = ag
        },
        _updateCache: function(ag) { this.offset = this.helper.offset(); if (this._isNumber(ag.left)) { this.position.left = ag.left } if (this._isNumber(ag.top)) { this.position.top = ag.top } if (this._isNumber(ag.height)) { this.size.height = ag.height } if (this._isNumber(ag.width)) { this.size.width = ag.width } },
        _updateRatio: function(ai) {
            var aj = this.position,
                ah = this.size,
                ag = this.axis;
            if (this._isNumber(ai.height)) { ai.width = (ai.height * this.aspectRatio) } else { if (this._isNumber(ai.width)) { ai.height = (ai.width / this.aspectRatio) } }
            if (ag === "sw") {
        ...
        _respectSize: function(al) {
            var ai = this._vBoundaries,
                ...
                ak = /sw|nw|w/.test(ao),
                ag = /nw|ne|n/.test(ao);
            if (aj) { al.width = ai.minWidth }
            if (ap) { al.height = ai.minHeight }
            if (aq) { al.width = ai.maxWidth }
            if (am) { al.height = ai.maxHeight }
            if (aj && ak) { al.left = ah - ai.minWidth }
            if (aq && ak) { al.left = ah - ai.maxWidth }
            if (ap && ag) { al.top = an - ai.minHeight }
            if (am && ag) { al.top = an - ai.maxHeight }
            if (!al.width && !al.height && !al.left && al.top) { al.top = null } else { if (!al.width && !al.height && !al.top && al.left) { al.left = null } }
            return al
        },
        _getPaddingPlusBorderDimensions: function(ai) {
            ...
            return { height: aj[0] + aj[2], width: aj[1] + aj[3] }
        },
        _proportionallyResize: function() {
            ...
            for (; ah < this._proportionallyResizeElements.length; ah++) {
                ...
                if (!this.outerDimensions) { this.outerDimensions = this._getPaddingPlusBorderDimensions(ai) }
                ai.css({ height: (ag.height() - this.outerDimensions.height) || 0, width: (ag.width() - this.outerDimensions.width) || 0 })
            }
        },
        _renderProxy: function() {
            ...
            if (this._helper) {
                ...
                this.helper.css({ width: this.element.outerWidth(), height: this.element.outerHeight(), position: "absolute", left: this.elementOffset.left + "px", top: this.elementOffset.top + "px", zIndex: ++ah.zIndex });
                this.helper.appendTo("body").disableSelection()
            } else { this.helper = this.element }
        },
        _change: {
            e: function(ah, ag) { return { width: this.originalSize.width + ag } },
            w: function(ai, ag) {
                var ah = this.originalSize,
                    aj = this.originalPosition;
                return { left: aj.left + ag, width: ah.width - ag }
            },
            n: function(aj, ah, ag) {
                var ai = this.originalSize,
                    ak = this.originalPosition;
                return { top: ak.top + ag, height: ai.height - ag }
            },
            s: function(ai, ah, ag) { return { height: this.originalSize.height + ag } },
            se: function(ai, ah, ag) { return K.extend(this._change.s.apply(this, arguments), this._change.e.apply(this, [ai, ah, ag])) },
            sw: function(ai, ah, ag) { return K.extend(this._change.s.apply(this, arguments), this._change.w.apply(this, [ai, ah, ag])) },
            ne: function(ai, ah, ag) { return K.extend(this._change.n.apply(this, arguments), this._change.e.apply(this, [ai, ah, ag])) },
            nw: function(ai, ah, ag) { return K.extend(this._change.n.apply(this, arguments), this._change.w.apply(this, [ai, ah, ag])) }
        },
    ...
    K.ui.plugin.add("resizable", "animate", {
        stop: function(aj) {
            var ao = K(this).resizable("instance"),
                ...
                ak = { width: (ao.size.width - an), height: (ao.size.height - ah) },
            ...
            ao.element.animate(K.extend(ak, ap && am ? { top: ap, left: am } : {}), {
                duration: al.animateDuration,
                easing: al.animateEasing,
                step: function() {
                    var aq = { width: parseFloat(ao.element.css("width")), height: parseFloat(ao.element.css("height")), top: parseFloat(ao.element.css("top")), left: parseFloat(ao.element.css("left")) };
                    if (ai && ai.length) { K(ai[0]).css({ width: aq.width, height: aq.height }) }
                    ao._updateCache(aq);
    ...
    K.ui.plugin.add("resizable", "containment", {
        start: function() {
            ...
            if (/document/.test(ah) || ah === document) {
                ap.containerOffset = { left: 0, top: 0 };
                ap.containerPosition = { left: 0, top: 0 };
                ap.parentData = { element: K(document), left: 0, top: 0, width: K(document).width(), height: K(document).height() || document.body.parentNode.scrollHeight }
            } else {
                ao = K(ak);
                ai = [];
                K(["Top", "Right", "Left", "Bottom"]).each(function(au, at) { ai[au] = ap._num(ao.css("padding" + at)) });
                ap.containerOffset = ao.offset();
                ap.containerPosition = ao.position();
                ap.containerSize = { height: (ao.innerHeight() - ai[3]), width: (ao.innerWidth() - ai[1]) };
                ...
                ap.parentData = { element: ak, left: aq.left, top: aq.top, width: aj, height: ar }
            }
        },
        resize: function(ah) {
            var an, at, am, ak, ao = K(this).resizable("instance"),
                ...
                al = true;
            if (ai[0] !== document && (/static/).test(ai.css("position"))) { ag = aq }
        ...
        stop: function() {
            ...
            if (al._helper && !ah.animate && (/relative/).test(ai.css("position"))) { K(this).css({ left: ao.left - ag.left - am.left, width: an, height: ak }) }
            if (al._helper && !ah.animate && (/static/).test(ai.css("position"))) { K(this).css({ left: ao.left - ag.left - am.left, width: an, height: ak }) }
        }
    });
    K.ui.plugin.add("resizable", "alsoResize", {
        start: function() {
            ...
            K(ah.alsoResize).each(function() {
                var ai = K(this);
                ai.data("ui-resizable-alsoresize", { width: parseFloat(ai.width()), height: parseFloat(ai.height()), left: parseFloat(ai.css("left")), top: parseFloat(ai.css("top")) })
            })
        },
        resize: function(ah, aj) {
            var ag = K(this).resizable("instance"),
                ...
                al = { height: (ag.size.height - ai.height) || 0, width: (ag.size.width - ai.width) || 0, top: (ag.position.top - am.top) || 0, left: (ag.position.left - am.left) || 0 };
            K(ak.alsoResize).each(function() {
                ...
                K.each(an, function(ar, au) { var at = (aq[au] || 0) + (al[au] || 0); if (at && at >= 0) { ao[au] = at || null } });
                ap.css(ao)
            })
        },
    ...
    K.ui.plugin.add("resizable", "ghost", {
        start: function() {
            ...
            ah.ghost.css({ opacity: 0.25, display: "block", position: "relative", height: ag.height, width: ag.width, margin: 0, left: 0, top: 0 });
            ah._addClass(ah.ghost, "ui-resizable-ghost");
            if (K.uiBackCompat !== false && typeof ah.options.ghost === "string") { ah.ghost.addClass(this.options.ghost) }
            ah.ghost.appendTo(ah.helper)
        },
        resize: function() { var ag = K(this).resizable("instance"); if (ag.ghost) { ag.ghost.css({ position: "relative", height: ag.size.height, width: ag.size.width }) } },
        stop: function() { var ag = K(this).resizable("instance"); if (ag.ghost && ag.helper) { ag.helper.get(0).removeChild(ag.ghost.get(0)) } }
    });
            ...
            if (/^(se|s|e)$/.test(ay)) {
                ...
                if (/^(ne)$/.test(ay)) {
                    ...
                    if (/^(sw)$/.test(ay)) {
                        ...
                        if (au - av <= 0 || aq - aw <= 0) { aj = ao._getPaddingPlusBorderDimensions(this) }
                        if (au - av > 0) {
                            ao.size.height = au;
                            ao.position.top = ap.top - ak
                        } else {
    ...
    var a = K.widget("ui.selectable", K.ui.mouse, {
        ...
        _create: function() {
            ...
            this.refresh = function() {
                ...
                ag.selectees.each(function() {
                    var ai = K(this),
                        ah = ai.offset(),
                        aj = { left: ah.left - ag.elementPos.left, top: ah.top - ag.elementPos.top };
                    K.data(this, "selectable-item", { element: this, $element: ai, left: aj.left, top: aj.top, right: aj.left + ai.outerWidth(), bottom: aj.top + ai.outerHeight(), startselected: false, selected: ai.hasClass("ui-selected"), selecting: ai.hasClass("ui-selecting"), unselecting: ai.hasClass("ui-unselecting") })
                })
            };
            this.refresh();
            this._mouseInit();
        ...
        _mouseStart: function(ai) {
            ...
            this.helper.css({ left: ai.pageX, top: ai.pageY, width: 0, height: 0 });
            if (ag.autoRefresh) { this.refresh() }
            this.selectees.filter(".ui-selected").each(function() {
                ...
                if (!ai.metaKey && !ai.ctrlKey) {
                    ...
                    aj.unselecting = true;
                    ah._trigger("unselecting", ai, { unselecting: aj.element })
                }
            });
            K(ai.target).parents().addBack().each(function() {
                ...
                if (ak) {
                    ...
                    ak.selecting = aj;
                    ak.selected = aj;
                    if (aj) { ah._trigger("selecting", ai, { selecting: ak.element }) } else { ah._trigger("unselecting", ai, { unselecting: ak.element }) }
                    return false
                }
            })
        },
        _mouseDrag: function(an) {
            ...
            this.helper.css({ left: ah, top: al, width: ag - ah, height: aj - al });
            this.selectees.each(function() {
                var ao = K.data(this, "selectable-item"),
                    ap = false,
                    aq = {};
                if (!ao || ao.element === am.element[0]) { return }
                ...
                if (ai.tolerance === "touch") { ap = (!(aq.left > ag || aq.right < ah || aq.top > aj || aq.bottom < al)) } else { if (ai.tolerance === "fit") { ap = (aq.left > ah && aq.right < ag && aq.top > al && aq.bottom < aj) } }
                if (ap) {
                    if (ao.selected) {
                    ...
                    if (!ao.selecting) {
                        ...
                        ao.selecting = true;
                        am._trigger("selecting", an, { selecting: ao.element })
                    }
                } else {
                    if (ao.selecting) {
                        if ((an.metaKey || an.ctrlKey) && ao.startselected) {
                            ...
                            am._trigger("unselecting", an, { unselecting: ao.element })
                        }
                    }
                    if (ao.selected) {
                        if (!an.metaKey && !an.ctrlKey && !ao.startselected) {
        ...
        _mouseStop: function(ah) {
            ...
            K(".ui-unselecting", this.element[0]).each(function() {
                ...
                ag._trigger("unselected", ah, { unselected: ai.element })
            });
            K(".ui-selecting", this.element[0]).each(function() {
                ...
                ag._trigger("selected", ah, { selected: ai.element })
            });
    ...
    var m = K.widget("ui.sortable", K.ui.mouse, {
        ...
        _isOverAxis: function(ah, ag, ai) { return (ah >= ag) && (ah < (ag + ai)) },
        _isFloating: function(ag) { return (/left|right/).test(ag.css("float")) || (/inline|table-cell/).test(ag.css("display")) },
        _create: function() {
            this.containerCache = {};
        ...
        _setOption: function(ag, ah) { this._super(ag, ah); if (ag === "handle") { this._setHandleClassName() } },
        _setHandleClassName: function() {
            var ag = this;
            this._removeClass(this.element.find(".ui-sortable-handle"), "ui-sortable-handle");
            K.each(this.items, function() { ag._addClass(this.instance.options.handle ? this.item.find(this.instance.options.handle) : this.item, "ui-sortable-handle") })
        },
        _destroy: function() { this._mouseDestroy(); for (var ag = this.items.length - 1; ag >= 0; ag--) { this.items[ag].item.removeData(this.widgetName + "-item") } return this },
        _mouseCapture: function(ai, aj) {
            ...
            K(ai.target).parents().each(function() { if (K.data(this, ah.widgetName + "-item") === ah) { ag = K(this); return false } });
            if (K.data(ai.target, ah.widgetName + "-item") === ah) { ag = K(ai.target) }
            if (!ag) { return false }
            if (this.options.handle && !aj) { K(this.options.handle, ag).find("*").addBack().each(function() { if (this === ai.target) { ak = true } }); if (!ak) { return false } }
            this.currentItem = ag;
        ...
        _mouseStart: function(aj, ak, ah) {
            ...
            K.extend(this.offset, { click: { left: aj.pageX - this.offset.left, top: aj.pageY - this.offset.top }, parent: this._getParentOffset(), relative: this._getRelativeOffset() });
            ...
            if (al.containment) { this._setContainment() }
            ...
            if (!ah) { for (ai = this.containers.length - 1; ai >= 0; ai--) { this.containers[ai]._trigger("activate", aj, this._uiHash(this)) } }
            if (K.ui.ddmanager) { K.ui.ddmanager.current = this }
            if (K.ui.ddmanager && !al.dropBehaviour) { K.ui.ddmanager.prepareOffsets(this, aj) }
            this.dragging = true;
        ...
        _mouseDrag: function(ak) {
            ...
            for (ai = this.items.length - 1; ai >= 0; ai--) {
                ...
                if (!am) { continue }
                if (aj.instance !== this.currentContainer) { continue }
                if (ah !== this.currentItem[0] && this.placeholder[am === 1 ? "next" : "prev"]()[0] !== ah && !K.contains(this.placeholder[0], ah) && (this.options.type === "semi-dynamic" ? !K.contains(this.element[0], ah) : true)) {
                    ...
                    if (this.options.tolerance === "pointer" || this._intersectsWithSides(aj)) { this._rearrange(ak, aj) } else { break }
                    this._trigger("change", ak, this._uiHash());
                    break
                }
            }
            this._contactContainers(ak);
            if (K.ui.ddmanager) { K.ui.ddmanager.drag(this, ak) }
        ...
        _mouseStop: function(ai, ak) {
            if (!ai) { return }
            if (K.ui.ddmanager && !this.options.dropBehaviour) { K.ui.ddmanager.drop(this, ai) }
            if (this.options.revert) {
                var ah = this,
                    al = this.placeholder.offset(),
                    ag = this.options.axis,
                    aj = {};
                if (!ag || ag === "x") { aj.left = al.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft) }
                if (!ag || ag === "y") { aj.top = al.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop) }
                this.reverting = true;
                K(this.helper).animate(aj, parseInt(this.options.revert, 10) || 500, function() { ah._clear(ai) })
            } else { this._clear(ai, ak) }
            return false
        },
        cancel: function() {
            if (this.dragging) {
            ...
            if (this.placeholder) {
                ...
                K.extend(this, { helper: null, dragging: false, reverting: false, _noFinalSort: null });
                if (this.domPosition.prev) { K(this.domPosition.prev).after(this.currentItem) } else { K(this.domPosition.parent).prepend(this.currentItem) }
            }
            return this
        },
        serialize: function(ai) {
            var ag = this._getItemsAsjQuery(ai && ai.connected),
                ah = [];
            ai = ai || {};
            K(ag).each(function() { var aj = (K(ai.item || this).attr(ai.attribute || "id") || "").match(ai.expression || (/(.+)[\-=_](.+)/)); if (aj) { ah.push((ai.key || aj[1] + "[]") + "=" + (ai.key && ai.expression ? aj[1] : aj[2])) } });
            if (!ah.length && ai.key) { ah.push(ai.key + "=") }
            return ah.join("&")
        },
        toArray: function(ai) {
            var ag = this._getItemsAsjQuery(ai && ai.connected),
                ah = [];
            ai = ai || {};
            ag.each(function() { ah.push(K(ai.item || this).attr(ai.attribute || "id") || "") });
            return ah
        },
        _intersectsWith: function(ar) {
            var ai = this.positionAbs.left,
                ...
                ak = al && aq;
            if (this.options.tolerance === "pointer" || this.options.forcePointerForContainers || (this.options.tolerance !== "pointer" && this.helperProportions[this.floating ? "width" : "height"] > ar[this.floating ? "width" : "height"])) { return ak } else { return (aj < ai + (this.helperProportions.width / 2) && ah - (this.helperProportions.width / 2) < ag && at < ap + (this.helperProportions.height / 2) && ao - (this.helperProportions.height / 2) < an) }
        },
        ...
        _intersectsWithSides: function(aj) {
            ...
            if (this.floating && ak) { return ((ak === "right" && ai) || (ak === "left" && !ai)) } else { return ag && ((ag === "down" && ah) || (ag === "up" && !ah)) }
        },
        _getDragVerticalDirection: function() { var ag = this.positionAbs.top - this.lastPositionAbs.top; return ag !== 0 && (ag > 0 ? "down" : "up") },
        _getDragHorizontalDirection: function() { var ag = this.positionAbs.left - this.lastPositionAbs.left; return ag !== 0 && (ag > 0 ? "right" : "left") },
        refresh: function(ag) {
        ...
        _connectWith: function() { var ag = this.options; return ag.connectWith.constructor === String ? [ag.connectWith] : ag.connectWith },
        _getItemsAsjQuery: function(ag) {
            ...
            aj.push([K.isFunction(this.options.items) ? this.options.items.call(this.element, null, { options: this.options, item: this.currentItem }) : K(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]);

            function ao() { al.push(this) }
            for (ai = aj.length - 1; ai >= 0; ai--) { aj[ai][0].each(ao) }
            return K(al)
        },
        _removeCurrentsFromItems: function() {
            var ag = this.currentItem.find(":data(" + this.widgetName + "-item)");
            this.items = K.grep(this.items, function(ai) { for (var ah = 0; ah < ag.length; ah++) { if (ag[ah] === ai.item[0]) { return false } } return true })
        },
        _refreshItems: function(ag) {
            ...
            var ak, ai, ap, al, ao, ah, ar, aq, am = this.items,
                aj = [
                    [K.isFunction(this.options.items) ? this.options.items.call(this.element[0], ag, { item: this.currentItem }) : K(this.options.items, this.element), this]
                ],
                ...
                for (ak = an.length - 1; ak >= 0; ak--) {
                    ...
                    for (ai = ap.length - 1; ai >= 0; ai--) {
                        ...
                        if (al && al !== this && !al.options.disabled) {
                            aj.push([K.isFunction(al.options.items) ? al.options.items.call(al.element[0], ag, { item: this.currentItem }) : K(al.options.items, al.element), al]);
            ...
            for (ak = aj.length - 1; ak >= 0; ak--) {
                ...
                for (ai = 0, aq = ah.length; ai < aq; ai++) {
                    ...
                    am.push({ item: ar, instance: ao, width: 0, height: 0, left: 0, top: 0 })
                }
            }
        },
        refreshPositions: function(ag) {
            ...
            for (ai = this.items.length - 1; ai >= 0; ai--) {
                aj = this.items[ai];
                if (aj.instance !== this.currentContainer && this.currentContainer && aj.item[0] !== this.currentItem[0]) { continue }
            ...
            if (!ai.placeholder || ai.placeholder.constructor === String) {
                ...
                ai.placeholder = {
                    element: function() {
                        ...
                        if (ak === "tbody") { ah._createTrPlaceholder(ah.currentItem.find("tr").eq(0), K("<tr>", ah.document[0]).appendTo(aj)) } else { if (ak === "tr") { ah._createTrPlaceholder(ah.currentItem, aj) } else { if (ak === "img") { aj.attr("src", ah.currentItem.attr("src")) } } }
                        if (!ag) { aj.css("visibility", "hidden") }
                        return aj
                    },
                    update: function(aj, ak) { if (ag && !ai.forcePlaceholderSize) { return } if (!ak.height()) { ak.height(ah.currentItem.innerHeight() - parseInt(ah.currentItem.css("paddingTop") || 0, 10) - parseInt(ah.currentItem.css("paddingBottom") || 0, 10)) } if (!ak.width()) { ak.width(ah.currentItem.innerWidth() - parseInt(ah.currentItem.css("paddingLeft") || 0, 10) - parseInt(ah.currentItem.css("paddingRight") || 0, 10)) } }
                }
            }
        ...
        _createTrPlaceholder: function(ah, ag) {
            var ai = this;
            ah.children().each(function() { K("<td>&#160;</td>", ai.document[0]).attr("colspan", K(this).attr("colspan") || 1).appendTo(ag) })
        },
        _contactContainers: function(ag) {
            var al, aj, ap, am, an, ar, at, ak, ao, ai, ah = null,
                aq = null;
            for (al = this.containers.length - 1; al >= 0; al--) {
                if (K.contains(this.currentItem[0], this.containers[al].element[0])) { continue }
                if (this._intersectsWith(this.containers[al].containerCache)) {
                    if (ah && K.contains(this.containers[al].element[0], ah.element[0])) { continue }
            ...
            if (this.containers.length === 1) {
                ...
                for (aj = this.items.length - 1; aj >= 0; aj--) {
                    if (!K.contains(this.containers[aq].element[0], this.items[aj].item[0])) { continue }
                    if (this.items[aj].item[0] === this.currentItem[0]) { continue }
                    at = this.items[aj].item.offset()[an];
                    ak = false;
                    if (ag[ai] - at > this.items[aj][ar] / 2) { ak = true }
                ...
                if (!am && !this.options.dropOnEmpty) { return }
        ...
        _createHelper: function(ah) {
            ...
            if (!ag.parents("body").length) { K(ai.appendTo !== "parent" ? ai.appendTo : this.currentItem[0].parentNode)[0].appendChild(ag[0]) }
            if (ag[0] === this.currentItem[0]) { this._storedCSS = { width: this.currentItem[0].style.width, height: this.currentItem[0].style.height, position: this.currentItem.css("position"), top: this.currentItem.css("top"), left: this.currentItem.css("left") } }
            if (!ag[0].style.width || ai.forceHelperSize) { ag.width(this.currentItem.width()) }
            if (!ag[0].style.height || ai.forceHelperSize) { ag.height(this.currentItem.height()) }
            return ag
        },
        _adjustOffsetFromHelper: function(ag) { if (typeof ag === "string") { ag = ag.split(" ") } if (K.isArray(ag)) { ag = { left: +ag[0], top: +ag[1] || 0 } } if ("left" in ag) { this.offset.click.left = ag.left + this.margins.left } if ("right" in ag) { this.offset.click.left = this.helperProportions.width - ag.right + this.margins.left } if ("top" in ag) { this.offset.click.top = ag.top + this.margins.top } if ("bottom" in ag) { this.offset.click.top = this.helperProportions.height - ag.bottom + this.margins.top } },
        _getParentOffset: function() {
            ...
            if (this.offsetParent[0] === this.document[0].body || (this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() === "html" && K.ui.ie)) { ag = { top: 0, left: 0 } }
            return { top: ag.top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0), left: ag.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0) }
        },
        _getRelativeOffset: function() { if (this.cssPosition === "relative") { var ag = this.currentItem.position(); return { top: ag.top - (parseInt(this.helper.css("top"), 10) || 0) + this.scrollParent.scrollTop(), left: ag.left - (parseInt(this.helper.css("left"), 10) || 0) + this.scrollParent.scrollLeft() } } else { return { top: 0, left: 0 } } },
        _cacheMargins: function() { this.margins = { left: (parseInt(this.currentItem.css("marginLeft"), 10) || 0), top: (parseInt(this.currentItem.css("marginTop"), 10) || 0) } },
        _cacheHelperProportions: function() { this.helperProportions = { width: this.helper.outerWidth(), height: this.helper.outerHeight() } },
        _setContainment: function() {
            var ah, aj, ag, ai = this.options;
            if (ai.containment === "parent") { ai.containment = this.helper[0].parentNode }
            if (ai.containment === "document" || ai.containment === "window") { this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, ai.containment === "document" ? this.document.width() : this.window.width() - this.helperProportions.width - this.margins.left, (ai.containment === "document" ? (this.document.height() || document.body.parentNode.scrollHeight) : this.window.height() || this.document[0].body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top] }
        ...
        _convertPositionTo: function(ai, ak) {
            ...
            return { top: (ak.top + this.offset.relative.top * ah + this.offset.parent.top * ah - ((this.cssPosition === "fixed" ? -this.scrollParent.scrollTop() : (aj ? 0 : ag.scrollTop())) * ah)), left: (ak.left + this.offset.relative.left * ah + this.offset.parent.left * ah - ((this.cssPosition === "fixed" ? -this.scrollParent.scrollLeft() : aj ? 0 : ag.scrollLeft()) * ah)) }
        },
        ...
        _rearrange: function(ak, aj, ah, ai) {
            ...
            var ag = this.counter;
            this._delay(function() { if (ag === this.counter) { this.refreshPositions(!ai) } })
        },
        _clear: function(ah, aj) {
            ...
            if (this.helper[0] === this.currentItem[0]) {
                for (ag in this._storedCSS) { if (this._storedCSS[ag] === "auto" || this._storedCSS[ag] === "static") { this._storedCSS[ag] = "" } }
                this.currentItem.css(this._storedCSS);
                this._removeClass(this.currentItem, "ui-sortable-helper")
            } else { this.currentItem.show() }
            if (this.fromOutside && !aj) { ak.push(function(al) { this._trigger("receive", al, this._uiHash(this.fromOutside)) }) }
            if ((this.fromOutside || this.domPosition.prev !== this.currentItem.prev().not(".ui-sortable-helper")[0] || this.domPosition.parent !== this.currentItem.parent()[0]) && !aj) { ak.push(function(al) { this._trigger("update", al, this._uiHash()) }) }
            if (this !== this.currentContainer) {
                if (!aj) {
                    ak.push(function(al) { this._trigger("remove", al, this._uiHash()) });
                    ak.push((function(al) { return function(am) { al._trigger("receive", am, this._uiHash(this)) } }).call(this, this.currentContainer));
                    ak.push((function(al) { return function(am) { al._trigger("update", am, this._uiHash(this)) } }).call(this, this.currentContainer))
                }
            }

            function ai(an, al, am) { return function(ao) { am._trigger(an, ao, al._uiHash(al)) } }
            for (ag = this.containers.length - 1; ag >= 0; ag--) {
                if (!aj) { ak.push(ai("deactivate", this, this.containers[ag])) }
                if (this.containers[ag].containerCache.over) {
            ...
            this.dragging = false;
            if (!aj) { this._trigger("beforeStop", ah, this._uiHash()) }
            ...
            if (!aj) {
                for (ag = 0; ag < ak.length; ag++) { ak[ag].call(this, ah) }
                this._trigger("stop", ah, this._uiHash())
            }
            this.fromOutside = false;
            return !this.cancelHelperRemoval
        },
        _trigger: function() { if (K.Widget.prototype._trigger.apply(this, arguments) === false) { this.cancel() } },
        _uiHash: function(ag) { var ah = ag || this; return { helper: ah.helper, placeholder: ah.placeholder || K([]), position: ah.position, originalPosition: ah.originalPosition, offset: ah.positionAbs, item: ah.currentItem, sender: ag ? ag.element : null } }
    });
    /*!
    ...
    function y(ah) {
        ...
        while (ah.length && ah[0] !== document) {
            ag = ah.css("position");
            if (ag === "absolute" || ag === "relative" || ag === "fixed") { ai = parseInt(ah.css("zIndex"), 10); if (!isNaN(ai) && ai !== 0) { return ai } }
            ah = ah.parent()
        }
        return 0
    }
    ...
    K.extend(ac.prototype, {
        ...
        setDefaults: function(ag) { F(this._defaults, ag || {}); return this },
        _attachDatepicker: function(aj, ag) {
            ...
            if (ak === "input") { this._connectDatepicker(aj, ah) } else { if (ai) { this._inlineDatepicker(aj, ah) } }
        },
        _newInst: function(ah, ag) { var ai = ah[0].id.replace(/([^A-Za-z0-9_\-])/g, "\\\\$1"); return { id: ai, input: ah, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: ag, dpDiv: (!ag ? this.dpDiv : l(K("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))) } },
        _connectDatepicker: function(ai, ah) {
            ...
            if (ah.settings.disabled) { this._disableDatepicker(ai) }
        },
        _attachments: function(ai, al) {
            var ah, ak, ag, am = this._get(al, "appendText"),
                aj = this._get(al, "isRTL");
            if (al.append) { al.append.remove() }
            if (am) {
                al.append = K("<span class='" + this._appendClass + "'>" + am + "</span>");
                ai[aj ? "before" : "after"](al.append)
            }
            ai.off("focus", this._showDatepicker);
            if (al.trigger) { al.trigger.remove() }
            ah = this._get(al, "showOn");
            if (ah === "focus" || ah === "both") { ai.on("focus", this._showDatepicker) }
            if (ah === "button" || ah === "both") {
                ak = this._get(al, "buttonText");
                ag = this._get(al, "buttonImage");
                al.trigger = K(this._get(al, "buttonImageOnly") ? K("<img/>").addClass(this._triggerClass).attr({ src: ag, alt: ak, title: ak }) : K("<button type='button'></button>").addClass(this._triggerClass).html(!ag ? ak : K("<img/>").attr({ src: ag, alt: ak, title: ak })));
                ai[aj ? "before" : "after"](al.trigger);
                al.trigger.on("click", function() {
                    if (K.datepicker._datepickerShowing && K.datepicker._lastInput === ai[0]) { K.datepicker._hideDatepicker() } else {
                        ...
                        } else { K.datepicker._showDatepicker(ai[0]) }
                    }
                    return false
                })
            }
        ...
        _inlineDatepicker: function(ah, ag) {
            var ai = K(ah);
            if (ai.hasClass(this.markerClassName)) { return }
            ...
            if (ag.settings.disabled) { this._disableDatepicker(ah) }
        ...
        _dialogDatepicker: function(an, ah, al, ai, am) {
            ...
            if (K.blockUI) { K.blockUI(this.dpDiv) }
            K.data(this._dialogInput[0], "datepicker", aj);
            return this
        },
        _destroyDatepicker: function(ai) {
            ...
            } else { if (aj === "div" || aj === "span") { ag.removeClass(this.markerClassName).empty() } }
            if (q === ah) { q = null }
        },
        _enableDatepicker: function(aj) {
            ...
            if (ak === "input") {
                aj.disabled = false;
                ah.trigger.filter("button").each(function() { this.disabled = false }).end().filter("img").css({ opacity: "1.0", cursor: "" })
            } else {
                if (ak === "div" || ak === "span") {
            ...
            this._disabledInputs = K.map(this._disabledInputs, function(al) { return (al === aj ? null : al) })
        },
        _disableDatepicker: function(aj) {
            ...
            if (ak === "input") {
                aj.disabled = true;
                ah.trigger.filter("button").each(function() { this.disabled = true }).end().filter("img").css({ opacity: "0.5", cursor: "default" })
            } else {
                if (ak === "div" || ak === "span") {
                    ai = ag.children("." + this._inlineClass);
        ...
        _isDisabledDatepicker: function(ah) { if (!ah) { return false } for (var ag = 0; ag < this._disabledInputs.length; ag++) { if (this._disabledInputs[ag] === ah) { return true } } return false },
        _getInst: function(ah) { try { return K.data(ah, "datepicker") } catch (ag) { throw "Missing instance data for this datepicker" } },
        _optionDatepicker: function(am, ah, al) {
            var ai, ag, ak, an, aj = this._getInst(am);
            if (arguments.length === 2 && typeof ah === "string") { return (ah === "defaults" ? K.extend({}, K.datepicker._defaults) : (aj ? (ah === "all" ? K.extend({}, aj.settings) : this._get(aj, ah)) : null)) }
            ai = ah || {};
            if (typeof ah === "string") {
                ai = {};
                ai[ah] = al
            ...
            if (aj) {
                if (this._curInst === aj) { this._hideDatepicker() }
                ag = this._getDateDatepicker(am, true);
                ak = this._getMinMaxDate(aj, "min");
                an = this._getMinMaxDate(aj, "max");
                F(aj.settings, ai);
                if (ak !== null && ai.dateFormat !== undefined && ai.minDate === undefined) { aj.settings.minDate = this._formatDate(aj, ak) }
                if (an !== null && ai.dateFormat !== undefined && ai.maxDate === undefined) { aj.settings.maxDate = this._formatDate(aj, an) }
                if ("disabled" in ai) { if (ai.disabled) { this._disableDatepicker(am) } else { this._enableDatepicker(am) } }
        ...
        _changeDatepicker: function(ai, ag, ah) { this._optionDatepicker(ai, ag, ah) },
        _refreshDatepicker: function(ah) { var ag = this._getInst(ah); if (ag) { this._updateDatepicker(ag) } },
        ...
        _getDateDatepicker: function(ai, ag) { var ah = this._getInst(ai); if (ah && !ah.inline) { this._setDateFromField(ah, ag) } return (ah ? this._getDate(ah) : null) },
        _doKeyDown: function(aj) {
            ...
            if (K.datepicker._datepickerShowing) {
                switch (aj.keyCode) {
                    ...
                    case 13:
                        ...
                        if (al[0]) { K.datepicker._selectDay(aj.target, ak.selectedMonth, ak.selectedYear, al[0]) }
                        ah = K.datepicker._get(ak, "onSelect");
                        if (ah) {
                            ag = K.datepicker._formatDate(ak);
                            ah.apply((ak.input ? ak.input[0] : null), [ag, ak])
                        } else { K.datepicker._hideDatepicker() }
                        return false;
                    case 27:
                        K.datepicker._hideDatepicker();
                        break;
                    ...
                    case 34:
                        ...
                        break;
                    case 35:
                        if (aj.ctrlKey || aj.metaKey) { K.datepicker._clearDate(aj.target) }
                        am = aj.ctrlKey || aj.metaKey;
                        break;
                    case 36:
                        if (aj.ctrlKey || aj.metaKey) { K.datepicker._gotoToday(aj.target) }
                        am = aj.ctrlKey || aj.metaKey;
                        break;
                    case 37:
                        if (aj.ctrlKey || aj.metaKey) { K.datepicker._adjustDate(aj.target, (ai ? +1 : -1), "D") }
                        am = aj.ctrlKey || aj.metaKey;
                        if (aj.originalEvent.altKey) { K.datepicker._adjustDate(aj.target, (aj.ctrlKey ? -K.datepicker._get(ak, "stepBigMonths") : -K.datepicker._get(ak, "stepMonths")), "M") }
                        break;
                    case 38:
                        if (aj.ctrlKey || aj.metaKey) { K.datepicker._adjustDate(aj.target, -7, "D") }
                        am = aj.ctrlKey || aj.metaKey;
                        break;
                    case 39:
                        if (aj.ctrlKey || aj.metaKey) { K.datepicker._adjustDate(aj.target, (ai ? -1 : +1), "D") }
            ...
            } else { if (aj.keyCode === 36 && aj.ctrlKey) { K.datepicker._showDatepicker(this) } else { am = false } }
            if (am) {
                aj.preventDefault();
                aj.stopPropagation()
            }
        ...
        _showDatepicker: function(ah) {
            ah = ah.target || ah;
            if (ah.nodeName.toLowerCase() !== "input") { ah = K("input", ah.parentNode)[0] }
            if (K.datepicker._isDisabledDatepicker(ah) || K.datepicker._lastInput === ah) { return }
            var aj, an, ai, al, am, ag, ak;
            aj = K.datepicker._getInst(ah);
            if (K.datepicker._curInst && K.datepicker._curInst !== aj) { K.datepicker._curInst.dpDiv.stop(true, true); if (aj && K.datepicker._datepickerShowing) { K.datepicker._hideDatepicker(K.datepicker._curInst.input[0]) } }
            ...
            K.datepicker._setDateFromField(aj);
            if (K.datepicker._inDialog) { ah.value = "" }
            if (!K.datepicker._pos) {
                K.datepicker._pos = K.datepicker._findPos(ah);
                K.datepicker._pos[1] += ah.offsetHeight
            }
            al = false;
            K(ah).parents().each(function() { al |= K(this).css("position") === "fixed"; return !al });
            am = { left: K.datepicker._pos[0], top: K.datepicker._pos[1] };
            K.datepicker._pos = null;
            aj.dpDiv.empty();
            aj.dpDiv.css({ position: "absolute", display: "block", top: "-1000px" });
            K.datepicker._updateDatepicker(aj);
            am = K.datepicker._checkOffset(aj, am, al);
            aj.dpDiv.css({ position: (K.datepicker._inDialog && K.blockUI ? "static" : (al ? "fixed" : "absolute")), display: "none", left: am.left + "px", top: am.top + "px" });
            if (!aj.inline) {
                ...
                if (K.effects && K.effects.effect[ag]) { aj.dpDiv.show(ag, K.datepicker._get(aj, "showOptions"), ak) } else { aj.dpDiv[ag || "show"](ag ? ak : null) }
                if (K.datepicker._shouldFocusInput(aj)) { aj.input.trigger("focus") }
        ...
        _updateDatepicker: function(aj) {
            ...
            if (ah.length > 0) { v.apply(ah.get(0)) }
            aj.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");
            if (ak > 1) { aj.dpDiv.addClass("ui-datepicker-multi-" + ak).css("width", (ai * ak) + "em") }
            ...
            if (aj === K.datepicker._curInst && K.datepicker._datepickerShowing && K.datepicker._shouldFocusInput(aj)) { aj.input.trigger("focus") }
            if (aj.yearshtml) {
                al = aj.yearshtml;
                setTimeout(function() {
                    if (al === aj.yearshtml && aj.yearshtml) { aj.dpDiv.find("select.ui-datepicker-year:first").replaceWith(aj.yearshtml) }
                    al = aj.yearshtml = null
                }, 0)
            }
        },
        _shouldFocusInput: function(ag) { return ag.input && ag.input.is(":visible") && !ag.input.is(":disabled") && !ag.input.is(":focus") },
        ...
        _findPos: function(aj) {
            ...
            while (aj && (aj.type === "hidden" || aj.nodeType !== 1 || K.expr.filters.hidden(aj))) { aj = aj[ah ? "previousSibling" : "nextSibling"] }
            ag = K(aj).offset();
            return [ag.left, ag.top]
        },
        _hideDatepicker: function(ai) {
            var ah, al, ak, ag, aj = this._curInst;
            if (!aj || (ai && aj !== K.data(ai, "datepicker"))) { return }
            if (this._datepickerShowing) {
                ah = this._get(aj, "showAnim");
                al = this._get(aj, "duration");
                ak = function() { K.datepicker._tidyDialog(aj) };
                if (K.effects && (K.effects.effect[ah] || K.effects[ah])) { aj.dpDiv.hide(ah, K.datepicker._get(aj, "showOptions"), al, ak) } else { aj.dpDiv[(ah === "slideDown" ? "slideUp" : (ah === "fadeIn" ? "fadeOut" : "hide"))]((ah ? al : null), ak) }
                if (!ah) { ak() }
                this._datepickerShowing = false;
                ag = this._get(aj, "onClose");
                if (ag) { ag.apply((aj.input ? aj.input[0] : null), [(aj.input ? aj.input.val() : ""), aj]) }
        ...
        _tidyDialog: function(ag) { ag.dpDiv.removeClass(this._dialogClass).off(".ui-datepicker-calendar") },
        _checkExternalClick: function(ah) {
            if (!K.datepicker._curInst) { return }
            var ag = K(ah.target),
                ai = K.datepicker._getInst(ag[0]);
            if (((ag[0].id !== K.datepicker._mainDivId && ag.parents("#" + K.datepicker._mainDivId).length === 0 && !ag.hasClass(K.datepicker.markerClassName) && !ag.closest("." + K.datepicker._triggerClass).length && K.datepicker._datepickerShowing && !(K.datepicker._inDialog && K.blockUI))) || (ag.hasClass(K.datepicker.markerClassName) && K.datepicker._curInst !== ai)) { K.datepicker._hideDatepicker() }
        },
        _adjustDate: function(ak, aj, ai) {
            var ah = K(ak),
                ag = this._getInst(ah[0]);
            if (this._isDisabledDatepicker(ah[0])) { return }
        ...
        _selectDay: function(al, aj, ag, ak) {
            var ah, ai = K(al);
            if (K(ak).hasClass(this._unselectableClass) || this._isDisabledDatepicker(ai[0])) { return }
            ah = this._getInst(ai[0]);
        ...
        _selectDate: function(ak, ag) {
            ...
            if (ai.input) { ai.input.val(ag) }
            this._updateAlternate(ai);
            ah = this._get(ai, "onSelect");
            if (ah) { ah.apply((ai.input ? ai.input[0] : null), [ag, ai]) } else { if (ai.input) { ai.input.trigger("change") } }
            if (ai.inline) { this._updateDatepicker(ai) } else {
                this._hideDatepicker();
                this._lastInput = ai.input[0];
                if (typeof(ai.input[0]) !== "object") { ai.input.trigger("focus") }
                this._lastInput = null
            }
        },
        ...
        noWeekends: function(ah) { var ag = ah.getDay(); return [(ag > 0 && ag < 6), ""] },
        ...
        parseDate: function(ax, ar, az) {
            if (ax == null || ar == null) { throw "Invalid arguments" }
            ...
            var aj, au, ah, ay = 0,
                ...
                ao = -1,
                av = false,
                aA, aq = function(aE) { var aF = (aj + 1 < ax.length && ax.charAt(aj + 1) === aE); if (aF) { aj++ } return aF },
                aD = function(aG) {
                    var aE = aq(aG),
                    ...
                    if (!aF) { throw "Missing number at position " + ay }
                    ay += aF[0].length;
                ...
                an = function(aF, aG, aI) {
                    var aE = -1,
                        ...
                        }).sort(function(aK, aJ) { return -(aK[1].length - aJ[1].length) });
                    ...
                    if (aE !== -1) { return aE + 1 } else { throw "Unknown name at position " + ay }
                },
                at = function() {
                    if (ar.charAt(ay) !== ax.charAt(aj)) { throw "Unexpected literal at position " + ay }
                    ay++
                };
            for (aj = 0; aj < ax.length; aj++) {
                if (av) { if (ax.charAt(aj) === "'" && !aq("'")) { av = false } else { at() } } else {
                    switch (ax.charAt(aj)) {
                        case "d":
                            aw = aD("d");
                            break;
            ...
            if (ay < ar.length) { ah = ar.substr(ay); if (!/^\s+/.test(ah)) { throw "Extra/unparsed characters found in date: " + ah } }
            if (al === -1) { al = new Date().getFullYear() } else { if (al < 100) { al += new Date().getFullYear() - new Date().getFullYear() % 100 + (al <= ai ? 0 : -100) } }
            if (ao > -1) {
                aC = 1;
                aw = ao;
                do {
            ...
            if (aA.getFullYear() !== al || aA.getMonth() + 1 !== aC || aA.getDate() !== aw) { throw "Invalid date" }
            return aA
        },
        ATOM: "yy-mm-dd",
        COOKIE: "D, dd M yy",
        ...
        formatDate: function(ap, aj, ak) {
            ...
            var ar, at = (ak ? ak.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                aq = function(au) { var av = (ar + 1 < ap.length && ap.charAt(ar + 1) === au); if (av) { ar++ } return av },
                ag = function(aw, ax, au) { var av = "" + ax; if (aq(aw)) { while (av.length < au) { av = "0" + av } } return av },
                am = function(au, aw, av, ax) { return (aq(au) ? ax[aw] : av[aw]) },
                ai = "",
                ao = false;
            if (aj) {
                for (ar = 0; ar < ap.length; ar++) {
                    if (ao) { if (ap.charAt(ar) === "'" && !aq("'")) { ao = false } else { ai += ap.charAt(ar) } } else {
                        switch (ap.charAt(ar)) {
                            case "d":
        ...
        _possibleChars: function(ak) {
            var aj, ai = "",
                ah = false,
                ag = function(al) { var am = (aj + 1 < ak.length && ak.charAt(aj + 1) === al); if (am) { aj++ } return am };
            for (aj = 0; aj < ak.length; aj++) {
                if (ah) { if (ak.charAt(aj) === "'" && !ag("'")) { ah = false } else { ai += ak.charAt(aj) } } else {
                    switch (ak.charAt(aj)) {
                        case "d":
                        case "m":
                        case "y":
        ...
        _get: function(ah, ag) { return ah.settings[ag] !== undefined ? ah.settings[ag] : this._defaults[ag] },
        _setDateFromField: function(al, ai) {
            if (al.input.val() === al.lastVal) { return }
            ...
            try { ah = this.parseDate(ag, an, aj) || am } catch (ak) { an = (ai ? "" : an) }
        ...
        _getDefaultDate: function(ag) { return this._restrictMinMax(ag, this._determineDate(ag, this._get(ag, "defaultDate"), new Date())) },
        _determineDate: function(ak, ah, al) {
            var aj = function(an) {
                ...
                ai = function(au) {
                    try { return K.datepicker.parseDate(K.datepicker._get(ak, "dateFormat"), au, K.datepicker._getFormatConfig(ak)) } catch (at) {}
        ...
        _generateHTML: function(aX) {
            ...
            for (aC = 0; aC < ax[0]; aC++) {
                ...
                for (aq = 0; aq < ax[1]; aq++) {
                    ...
                    if (aU === aX.selectedYear && ag === aX.selectedMonth) { aX.selectedDay = Math.min(aX.selectedDay, ao) }
        ...
        _generateMonthYearHeader: function(ak, ai, at, am, aq, au, ao, ag) {
            var ay, ah, az, aw, al, av, ar, an, aj = this._get(ak, "changeMonth"),
                ...
                ax = "";
            if (au || !aj) { ax += "<span class='ui-datepicker-month'>" + ao[ai] + "</span>" } else {
                ...
                for (az = 0; az < 12; az++) { if ((!ay || az >= am.getMonth()) && (!ah || az <= aq.getMonth())) { ax += "<option value='" + az + "'" + (az === ai ? " selected='selected'" : "") + ">" + ag[az] + "</option>" } }
                ax += "</select>"
            }
            if (!aB) { ap += ax + (au || !(aj && aA) ? "&#xa0;" : "") }
            if (!ak.yearshtml) {
                ak.yearshtml = "";
                if (au || !aA) { ap += "<span class='ui-datepicker-year'>" + at + "</span>" } else {
                    aw = this._get(ak, "yearRange").split(":");
                    al = new Date().getFullYear();
                    av = function(aD) { var aC = (aD.match(/c[+\-].*/) ? at + parseInt(aD.substring(1), 10) : (aD.match(/[+\-].*/) ? al + parseInt(aD, 10) : parseInt(aD, 10))); return (isNaN(aC) ? al : aC) };
                    ar = av(aw[0]);
                    ...
                    for (; ar <= an; ar++) { ak.yearshtml += "<option value='" + ar + "'" + (ar === at ? " selected='selected'" : "") + ">" + ar + "</option>" }
                    ak.yearshtml += "</select>";
                    ap += ak.yearshtml;
                    ak.yearshtml = null
                }
        ...
        _adjustInstDate: function(aj, am, al) {
            ...
            if (al === "M" || al === "Y") { this._notifyChange(aj) }
        },
        ...
        _notifyChange: function(ah) { var ag = this._get(ah, "onChangeMonthYear"); if (ag) { ag.apply((ah.input ? ah.input[0] : null), [ah.selectedYear, ah.selectedMonth + 1, ah]) } },
        _getNumberOfMonths: function(ah) { var ag = this._get(ah, "numberOfMonths"); return (ag == null ? [1, 1] : (typeof ag === "number" ? [1, ag] : ag)) },
        _getMinMaxDate: function(ah, ag) { return this._determineDate(ah, this._get(ah, ag + "Date"), null) },
        _getDaysInMonth: function(ag, ah) { return 32 - this._daylightSavingAdjust(new Date(ag, ah, 32)).getDate() },
        _getFirstDayOfMonth: function(ag, ah) { return new Date(ag, ah, 1).getDay() },
        _canAdjustMonth: function(aj, al, ai, ak) {
            ...
            if (al < 0) { ah.setDate(this._getDaysInMonth(ah.getFullYear(), ah.getMonth())) }
        ...
        _getFormatConfig: function(ag) {
            ...
            return { shortYearCutoff: ah, dayNamesShort: this._get(ag, "dayNamesShort"), dayNames: this._get(ag, "dayNames"), monthNamesShort: this._get(ag, "monthNamesShort"), monthNames: this._get(ag, "monthNames") }
        },
    ...
    function l(ah) { var ag = "button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a"; return ah.on("mouseout", ag, function() { K(this).removeClass("ui-state-hover"); if (this.className.indexOf("ui-datepicker-prev") !== -1) { K(this).removeClass("ui-datepicker-prev-hover") } if (this.className.indexOf("ui-datepicker-next") !== -1) { K(this).removeClass("ui-datepicker-next-hover") } }).on("mouseover", ag, v) }
    ...
    function v() {
        if (!K.datepicker._isDisabledDatepicker(q.inline ? q.dpDiv.parent()[0] : q.input[0])) {
            ...
            if (this.className.indexOf("ui-datepicker-prev") !== -1) { K(this).addClass("ui-datepicker-prev-hover") }
            if (this.className.indexOf("ui-datepicker-next") !== -1) { K(this).addClass("ui-datepicker-next-hover") }
        }
    }

    function F(ai, ah) { K.extend(ai, ah); for (var ag in ah) { if (ah[ag] == null) { ai[ag] = ah[ag] } } return ai }
    K.fn.datepicker = function(ah) {
        ...
        if (K("#" + K.datepicker._mainDivId).length === 0) { K("body").append(K.datepicker.dpDiv) }
        var ag = Array.prototype.slice.call(arguments, 1);
        if (typeof ah === "string" && (ah === "isDisabled" || ah === "getDate" || ah === "widget")) { return K.datepicker["_" + ah + "Datepicker"].apply(K.datepicker, [this[0]].concat(ag)) }
        if (ah === "option" && arguments.length === 2 && typeof arguments[1] === "string") { return K.datepicker["_" + ah + "Datepicker"].apply(K.datepicker, [this[0]].concat(ag)) }
        return this.each(function() { typeof ah === "string" ? K.datepicker["_" + ah + "Datepicker"].apply(K.datepicker, [this].concat(ag)) : K.datepicker._attachDatepicker(this, ah) })
    };
    K.datepicker = new ac();
    ...
    var d = K.widget("ui.slider", K.ui.mouse, {
        ...
        _createHandles: function() {
            ...
            for (aj = al.length; aj < ag; aj++) { ai.push(ak) }
            this.handles = al.add(K(ai.join("")).appendTo(this.element));
            this._addClass(this.handles, "ui-slider-handle", "ui-state-default");
            this.handle = this.handles.eq(0);
            this.handles.each(function(am) { K(this).data("ui-slider-handle-index", am).attr("tabIndex", 0) })
        },
        _createRange: function() {
            var ag = this.options;
            if (ag.range) {
                if (ag.range === true) { if (!ag.values) { ag.values = [this._valueMin(), this._valueMin()] } else { if (ag.values.length && ag.values.length !== 2) { ag.values = [ag.values[0], ag.values[0]] } else { if (K.isArray(ag.values)) { ag.values = ag.values.slice(0) } } } }
                ...
                if (ag.range === "min" || ag.range === "max") { this._addClass(this.range, "ui-slider-range-" + ag.range) }
            } else {
        ...
        _mouseCapture: function(ai) {
            var am, ap, ah, ak, ao, aq, al, ag, an = this,
                aj = this.options;
            if (aj.disabled) { return false }
            this.elementSize = { width: this.element.outerWidth(), height: this.element.outerHeight() };
            this.elementOffset = this.element.offset();
            am = { x: ai.pageX, y: ai.pageY };
            ...
            this._clickOffset = ag ? { left: 0, top: 0 } : { left: ai.pageX - al.left - (ak.width() / 2), top: ai.pageY - al.top - (ak.height() / 2) - (parseInt(ak.css("borderTopWidth"), 10) || 0) - (parseInt(ak.css("borderBottomWidth"), 10) || 0) + (parseInt(ak.css("marginTop"), 10) || 0) };
            if (!this.handles.hasClass("ui-state-hover")) { this._slide(ai, ao, ap) }
            this._animateOff = true;
            return true
        },
        _mouseStart: function() { return true },
        _mouseDrag: function(ai) {
            var ag = { x: ai.pageX, y: ai.pageY },
        ...
        _normValueFromMouse: function(ah) {
            ...
            if (aj > 1) { aj = 1 }
            if (aj < 0) { aj = 0 }
            if (this.orientation === "vertical") { aj = 1 - aj }
            ai = this._valueMax() - this._valueMin();
            al = this._valueMin() + aj * ai;
            return this._trimAlignValue(al)
        },
        _uiHash: function(ai, aj, ag) {
            var ah = { handle: this.handles[ai], handleIndex: ai, value: aj !== undefined ? aj : this.value() };
        ...
        _start: function(ah, ag) { return this._trigger("start", ah, this._uiHash(ag)) },
        _slide: function(al, aj, ai) {
            ...
            if (this._hasMultipleValues()) {
                ...
                ak = this.values(aj);
                if (this.options.values.length === 2 && this.options.range === true) { ai = aj === 0 ? Math.min(ag, ai) : Math.max(ag, ai) }
                ah[aj] = ai
            }
            if (ai === ak) { return }
            am = this._trigger("slide", al, this._uiHash(aj, ai, ah));
            if (am === false) { return }
            if (this._hasMultipleValues()) { this.values(aj, ai) } else { this.value(ai) }
        },
        _stop: function(ah, ag) { this._trigger("stop", ah, this._uiHash(ag)) },
        ...
        values: function(ah, ak) {
            ...
            if (arguments.length) {
                if (K.isArray(arguments[0])) {
                    ...
                    this._refreshValue()
                } else { if (this._hasMultipleValues()) { return this._values(ah) } else { return this.value() } }
        ...
        _setOption: function(ah, ai) {
            ...
            if (K.isArray(this.options.values)) { aj = this.options.values.length }
            this._super(ah, ai);
            switch (ah) {
                case "orientation":
                    this._detectOrientation();
                    ...
                    this._refreshValue();
                    if (this.options.range) { this._refreshRange(ai) }
                ...
                case "values":
                    this._animateOff = true;
                    this._refreshValue();
                    for (ag = aj - 1; ag >= 0; ag--) { this._change(null, ag) }
                    this._animateOff = false;
                    break;
                case "step":
                case "min":
        ...
        _values: function(ag) {
            ...
            if (arguments.length) {
                ...
                return aj
            } else { if (this._hasMultipleValues()) { ai = this.options.values.slice(); for (ah = 0; ah < ai.length; ah += 1) { ai[ah] = this._trimAlignValue(ai[ah]) } return ai } else { return [] } }
        },
        _trimAlignValue: function(aj) {
            if (aj <= this._valueMin()) { return this._valueMin() }
            if (aj >= this._valueMax()) { return this._valueMax() }
            var ag = (this.options.step > 0) ? this.options.step : 1,
                ai = (aj - this._valueMin()) % ag,
                ah = aj - ai;
            if (Math.abs(ai) * 2 >= ag) { ah += (ai > 0) ? ag : (-ag) }
        ...
        _calculateNewMax: function() {
            ...
            ag = aj + ah;
            if (ag > this.options.max) { ag -= ai }
            this.max = parseFloat(ag.toFixed(this._precision()))
        },
        _precision: function() { var ag = this._precisionOf(this.options.step); if (this.options.min !== null) { ag = Math.max(ag, this._precisionOf(this.options.min)) } return ag },
        ...
        _refreshRange: function(ag) { if (ag === "vertical") { this.range.css({ width: "", left: "" }) } if (ag === "horizontal") { this.range.css({ height: "", bottom: "" }) } },
        _refreshValue: function() {
            ...
            if (this._hasMultipleValues()) {
                this.handles.each(function(aq) {
                    ...
                    if (an.options.range === true) { if (an.orientation === "horizontal") { if (aq === 0) { an.range.stop(1, 1)[ah ? "animate" : "css"]({ left: ak + "%" }, ai.animate) } if (aq === 1) { an.range[ah ? "animate" : "css"]({ width: (ak - al) + "%" }, { queue: false, duration: ai.animate }) } } else { if (aq === 0) { an.range.stop(1, 1)[ah ? "animate" : "css"]({ bottom: (ak) + "%" }, ai.animate) } if (aq === 1) { an.range[ah ? "animate" : "css"]({ height: (ak - al) + "%" }, { queue: false, duration: ai.animate }) } } }
                    al = ak
                })
            } else {
                ao = this.value();
                ...
                if (aj === "min" && this.orientation === "horizontal") { this.range.stop(1, 1)[ah ? "animate" : "css"]({ width: ak + "%" }, ai.animate) }
                if (aj === "max" && this.orientation === "horizontal") { this.range.stop(1, 1)[ah ? "animate" : "css"]({ width: (100 - ak) + "%" }, ai.animate) }
                if (aj === "min" && this.orientation === "vertical") { this.range.stop(1, 1)[ah ? "animate" : "css"]({ height: ak + "%" }, ai.animate) }
                if (aj === "max" && this.orientation === "vertical") { this.range.stop(1, 1)[ah ? "animate" : "css"]({ height: (100 - ak) + "%" }, ai.animate) }
            }
        },
        _handleEvents: {
            keydown: function(ak) {
                ...
                if (this._hasMultipleValues()) { ai = ah = this.values(ag) } else { ai = ah = this.value() }
                switch (ak.keyCode) {
                    case K.ui.keyCode.HOME:
                        ah = this._valueMin();
                        break;
                    ...
                    case K.ui.keyCode.UP:
                    case K.ui.keyCode.RIGHT:
                        if (ai === this._valueMax()) { return }
                        ah = this._trimAlignValue(ai + aj);
                        break;
                    case K.ui.keyCode.DOWN:
                    case K.ui.keyCode.LEFT:
                        if (ai === this._valueMin()) { return }
                        ah = this._trimAlignValue(ai - aj);
                        break
                }
    ...
    (function(av, aj) {
        ...
        ar(ap, function(aw, ax) {
            ax.cache = "_" + aw;
            ax.props.alpha = { idx: 3, type: "percent", def: 1 }
        });

        function ao(ax, az, ay) {
            var aw = au[az.type] || {};
            if (ax == null) { return (ay || !az.def) ? null : az.def }
            ax = aw.floor ? ~~ax : parseFloat(ax);
            if (isNaN(ax)) { return az.def }
            if (aw.mod) { return (ax + aw.mod) % aw.mod }
        ...
        function al(aw) {
            ...
            if (ax.length) { if (ax.join() === "0,0,0,0") { av.extend(ax, ag.transparent) } return ay }
            return ag[aw]
        }
        ak.fn = av.extend(ak.prototype, {
            parse: function(aC, aA, aw, aB) {
                if (aC === aj) { this._rgba = [null, null, null, null]; return this }
                ...
                if (ay === "string") { return this.parse(al(aC) || ag._default) }
                if (ay === "array") { ar(ap.rgba.props, function(aD, aE) { ax[aE.idx] = ao(aC[aE.idx], aE) }); return this }
                if (ay === "object") {
                    if (aC instanceof ak) { ar(ap, function(aD, aE) { if (aC[aE.cache]) { az[aE.cache] = aC[aE.cache].slice() } }) } else {
                        ar(ap, function(aE, aF) {
                            var aD = aF.cache;
                            ar(aF.props, function(aG, aH) {
                                if (!az[aD] && aF.to) {
                                    if (aG === "alpha" || aC[aG] == null) { return }
                                    az[aD] = aF.to(az._rgba)
                                }
                                az[aD][aH.idx] = ao(aC[aG], aH, true)
                            });
                            if (az[aD] && av.inArray(null, az[aD].slice(0, 3)) < 0) { az[aD][3] = 1; if (aF.from) { az._rgba = aF.from(az[aD]) } }
                        })
                    }
                    return this
                }
            ...
            is: function(ay) {
                ...
                ar(ap, function(aA, aC) {
                    ...
                    if (aB) {
                        ...
                        ar(aC.props, function(aE, aF) { if (aB[aF.idx] != null) { az = (aB[aF.idx] === aD[aF.idx]); return az } })
                    }
                    return az
                });
                return az
            ...
            _space: function() {
                var aw = [],
                    ax = this;
                ar(ap, function(ay, az) { if (ax[az.cache]) { aw.push(ay) } });
                return aw.pop()
            },
            transition: function(ax, aD) {
                ...
                ar(aA.props, function(aH, aJ) {
                    var aG = aJ.idx,
                        ...
                        aI = au[aJ.type] || {};
                    if (aE === null) { return }
                    if (aF === null) { aw[aG] = aE } else {
                        if (aI.mod) { if (aE - aF > aI.mod / 2) { aF += aI.mod } else { if (aF - aE > aI.mod / 2) { aF -= aI.mod } } }
            ...
            blend: function(az) {
                ...
                var ay = this._rgba.slice(),
                    ax = ay.pop(),
                    aw = ak(az)._rgba;
                return ak(av.map(ay, function(aA, aB) { return (1 - ax) * aw[aB] + ax * aA }))
            },
            toRgbaString: function() {
                var ax = "rgba(",
                    aw = av.map(this._rgba, function(ay, az) { return ay == null ? (az > 2 ? 1 : 0) : ay });
                if (aw[3] === 1) {
                    aw.pop();
                    ax = "rgb("
                }
            ...
            toHslaString: function() {
                var ax = "hsla(",
                    aw = av.map(this.hsla(), function(ay, az) { if (ay == null) { ay = az > 2 ? 1 : 0 } if (az && az < 3) { ay = Math.round(ay * 100) + "%" } return ay });
                if (aw[3] === 1) {
                    aw.pop();
                    ax = "hsl("
                }
            ...
            toHexString: function(aw) {
                var ax = this._rgba.slice(),
                    ay = ax.pop();
                if (aw) { ax.push(~~(ay * 255)) }
                return "#" + av.map(ax, function(az) { az = (az || 0).toString(16); return az.length === 1 ? "0" + az : az }).join("")
            },
            toString: function() { return this._rgba[3] === 0 ? "transparent" : this.toRgbaString() }
        });
        ak.fn.parse.prototype = ak.fn;

        function ai(ay, ax, aw) { aw = (aw + 1) % 1; if (aw * 6 < 1) { return ay + (ax - ay) * aw * 6 } if (aw * 2 < 1) { return ax } if (aw * 3 < 2) { return ay + (ax - ay) * ((2 / 3) - aw) * 6 } return ay }
        ap.hsla.to = function(ay) {
            if (ay[0] == null || ay[1] == null || ay[2] == null) { return [null, null, null, ay[3]] }
            var aw = ay[0] / 255,
                aB = ay[1] / 255,
                aC = ay[2] / 255,
                aE = ay[3],
                ...
                ax = aG * 0.5,
                aA, aH;
            if (az === aD) { aA = 0 } else { if (aw === aD) { aA = (60 * (aB - aC) / aF) + 360 } else { if (aB === aD) { aA = (60 * (aC - aw) / aF) + 120 } else { aA = (60 * (aw - aB) / aF) + 240 } } }
            if (aF === 0) { aH = 0 } else { if (ax <= 0.5) { aH = aF / aG } else { aH = aF / (2 - aG) } }
            return [Math.round(aA) % 360, aH, ax, aE == null ? 1 : aE]
        };
        ap.hsla.from = function(aA) {
            if (aA[0] == null || aA[1] == null || aA[2] == null) { return [null, null, null, aA[3]] }
            var az = aA[0] / 360,
                ay = aA[1],
                ax = aA[2],
                aw = aA[3],
            ...
            ar(ay, function(aC, aD) {
                ...
                ak.fn[aC] = function(aH) {
                    var aJ = av.type(aH),
                        ...
                        aI = aF[aD.idx],
                        aE;
                    if (aJ === "undefined") { return aI }
                    if (aJ === "function") {
                        aH = aH.call(this, aI);
                        aJ = av.type(aH)
                    }
                    if (aH == null && aD.empty) { return this }
                    if (aJ === "string") { aE = an.exec(aH); if (aE) { aH = aI + parseFloat(aE[2]) * (aE[1] === "+" ? 1 : -1) } }
                    aF[aD.idx] = aH;
                    return this[aG](aF)
                }
            })
        ...
        av.cssHooks.borderColor = {
            expand: function(ax) {
                var aw = {};
                ar(["Top", "Right", "Bottom", "Left"], function(az, ay) { aw["border" + ay + "Color"] = ax });
                return aw
            }
        };
        ag = av.Color.names = { aqua: "#00ffff", black: "#000000", blue: "#0000ff", fuchsia: "#ff00ff", gray: "#808080", green: "#008000", lime: "#00ff00", maroon: "#800000", navy: "#000080", olive: "#808000", purple: "#800080", red: "#ff0000", silver: "#c0c0c0", teal: "#008080", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff" }
    })(x);
    (function() {
        var ah = ["add", "remove", "toggle"],
            ai = { border: 1, borderBottom: 1, borderColor: 1, borderLeft: 1, borderRight: 1, borderTop: 1, borderWidth: 1, margin: 1, padding: 1 };
        ...
        function aj(ao) {
            var al, ak, am = ao.ownerDocument.defaultView ? ao.ownerDocument.defaultView.getComputedStyle(ao, null) : ao.currentStyle,
                an = {};
            if (am && am.length && am[0] && am[am[0]]) { ak = am.length; while (ak--) { al = am[ak]; if (typeof am[al] === "string") { an[K.camelCase(al)] = am[al] } } } else { for (al in am) { if (typeof am[al] === "string") { an[al] = am[al] } } }
            return an
        }
        ...
        function ag(ak, am) {
            var ao = {},
                al, an;
            for (al in am) { an = am[al]; if (ak[al] !== an) { if (!ai[al]) { if (K.fx.step[al] || !isNaN(parseFloat(an))) { ao[al] = an } } } }
            return ao
        }
        if (!K.fn.addBack) { K.fn.addBack = function(ak) { return this.add(ak == null ? this.prevObject : this.prevObject.filter(ak)) } }
        K.effects.animateClass = function(ak, al, ao, an) {
            ...
            return this.queue(function() {
                ...
                at = at.map(function() { var au = K(this); return { el: au, start: aj(this) } });
                aq = function() { K.each(ah, function(au, av) { if (ak[av]) { ar[av + "Class"](ak[av]) } }) };
                aq();
                at = at.map(function() {
                ...
                at = at.map(function() {
                    var aw = this,
                        au = K.Deferred(),
                        av = K.extend({}, am, { queue: false, complete: function() { au.resolve(aw) } });
                ...
                K.when.apply(K, at.get()).done(function() {
                    ...
                    K.each(arguments, function() {
                        var au = this.el;
                        K.each(this.diff, function(av) { au.css(av, "") })
                    });
                    am.complete.call(ar[0])
                })
            })
        };
        K.fn.extend({ addClass: (function(ak) { return function(am, al, ao, an) { return al ? K.effects.animateClass.call(this, { add: am }, al, ao, an) : ak.apply(this, arguments) } })(K.fn.addClass), removeClass: (function(ak) { return function(am, al, ao, an) { return arguments.length > 1 ? K.effects.animateClass.call(this, { remove: am }, al, ao, an) : ak.apply(this, arguments) } })(K.fn.removeClass), toggleClass: (function(ak) { return function(an, am, al, ap, ao) { if (typeof am === "boolean" || am === undefined) { if (!al) { return ak.apply(this, arguments) } else { return K.effects.animateClass.call(this, (am ? { add: an } : { remove: an }), al, ap, ao) } } else { return K.effects.animateClass.call(this, { toggle: an }, am, al, ap) } } })(K.fn.toggleClass), switchClass: function(ak, am, al, ao, an) { return K.effects.animateClass.call(this, { add: am, remove: ak }, al, ao, an) } })
    })();
    (function() {
        if (K.expr && K.expr.filters && K.expr.filters.animated) { K.expr.filters.animated = (function(aj) { return function(ak) { return !!K(ak).data(u) || aj(ak) } })(K.expr.filters.animated) }
        if (K.uiBackCompat !== false) {
            K.extend(K.effects, {
                save: function(ak, am) {
                    var aj = 0,
                        al = am.length;
                    for (; aj < al; aj++) { if (am[aj] !== null) { ak.data(o + am[aj], ak[0].style[am[aj]]) } }
                },
                ...
                setMode: function(aj, ak) { if (ak === "toggle") { ak = aj.is(":hidden") ? "show" : "hide" } return ak },
                createWrapper: function(ak) {
                    if (ak.parent().is(".ui-effects-wrapper")) { return ak.parent() }
                    var al = { width: ak.outerWidth(true), height: ak.outerHeight(true), "float": ak.css("float") },
                        ao = K("<div></div>").addClass("ui-effects-wrapper").css({ fontSize: "100%", background: "transparent", border: "none", margin: 0, padding: 0 }),
                        aj = { width: ak.width(), height: ak.height() },
                        an = document.activeElement;
                    try { an.id } catch (am) { an = document.body }
                    ak.wrap(ao);
                    if (ak[0] === an || K.contains(ak[0], an)) { K(an).trigger("focus") }
                    ao = ak.parent();
                    if (ak.css("position") === "static") {
                        ao.css({ position: "relative" });
                        ak.css({ position: "relative" })
                    } else {
                        K.extend(al, { position: ak.css("position"), zIndex: ak.css("z-index") });
                        K.each(["top", "left", "bottom", "right"], function(ap, aq) { al[aq] = ak.css(aq); if (isNaN(parseInt(al[aq], 10))) { al[aq] = "auto" } });
                        ak.css({ position: "relative", top: 0, left: 0, right: "auto", bottom: "auto" })
                    }
                    ak.css(aj);
                    return ao.css(al).show()
                },
                removeWrapper: function(aj) { var ak = document.activeElement; if (aj.parent().is(".ui-effects-wrapper")) { aj.parent().replaceWith(aj); if (aj[0] === ak || K.contains(aj[0], ak)) { K(ak).trigger("focus") } } return aj }
            })
        }
        K.extend(K.effects, {
            version: "1.12.1",
            ...
            scaledDimensions: function(ak, al, am) {
                if (al === 0) { return { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } }
                var aj = am !== "horizontal" ? ((al || 100) / 100) : 1,
                    an = am !== "vertical" ? ((al || 100) / 100) : 1;
                return { height: ak.height() * an, width: ak.width() * aj, outerHeight: ak.outerHeight() * an, outerWidth: ak.outerWidth() * aj }
            },
            clipToBox: function(aj) { return { width: aj.clip.right - aj.clip.left, height: aj.clip.bottom - aj.clip.top, left: aj.clip.left, top: aj.clip.top } },
            unshift: function(ak, am, al) {
                var aj = ak.queue();
                if (am > 1) { aj.splice.apply(aj, [1, 0].concat(aj.splice(am, al))) }
                ak.dequeue()
            },
            saveStyle: function(aj) { aj.data(t, aj[0].style.cssText) },
            restoreStyle: function(aj) {
                aj[0].style.cssText = aj.data(t) || "";
                aj.removeData(t)
            },
            mode: function(aj, al) { var ak = aj.is(":hidden"); if (al === "toggle") { al = ak ? "show" : "hide" } if (ak ? al === "hide" : al === "show") { al = "none" } return al },
            ...
            createPlaceholder: function(ak) {
                var am, al = ak.css("position"),
                    aj = ak.position();
                ak.css({ marginTop: ak.css("marginTop"), marginBottom: ak.css("marginBottom"), marginLeft: ak.css("marginLeft"), marginRight: ak.css("marginRight") }).outerWidth(ak.outerWidth()).outerHeight(ak.outerHeight());
                if (/^(static|relative)/.test(al)) {
                    al = "absolute";
                    am = K("<" + ak[0].nodeName + ">").insertAfter(ak).css({ display: /^(inline|ruby)/.test(ak.css("display")) ? "inline-block" : "block", visibility: "hidden", marginTop: ak.css("marginTop"), marginBottom: ak.css("marginBottom"), marginLeft: ak.css("marginLeft"), marginRight: ak.css("marginRight"), "float": ak.css("float") }).outerWidth(ak.outerWidth()).outerHeight(ak.outerHeight()).addClass("ui-effects-placeholder");
            ...
            setTransition: function(ak, am, aj, al) {
                al = al || {};
                K.each(am, function(ao, an) { var ap = ak.cssUnit(an); if (ap[0] > 0) { al[an] = ap[0] * aj + ap[1] } });
                return al
            }
        });
        ...
        function ai(aj) { if (!aj || typeof aj === "number" || K.fx.speeds[aj]) { return true } if (typeof aj === "string" && !K.effects.effect[aj]) { return true } if (K.isFunction(aj)) { return true } if (typeof aj === "object" && !aj.effect) { return true } return false }
        K.fn.extend({
            effect: function() {
                var ar = ah.apply(this, arguments),
                    ...
                    at = function(aw) {
                        ...
                        av.data(u, true);
                        ak.push(au);
                        if (an && (au === "show" || (au === an && au === "hide"))) { av.show() }
                        if (!an || au !== "none") { K.effects.saveStyle(av) }
                        if (K.isFunction(aw)) { aw() }
                    };
                if (K.fx.off || !aq) { if (ao) { return this[ao](ar.duration, aj) } else { return this.each(function() { if (aj) { aj.call(this) } }) } }
                ...
                function al(aw) {
                    ...
                    function av() {
                        ...
                        if (ar.mode === "hide") { ax.hide() }
                        au()
                    }

                    function au() { if (K.isFunction(aj)) { aj.call(ax[0]) } if (K.isFunction(aw)) { aw() } }
                    ar.mode = ak.shift();
                    if (K.uiBackCompat !== false && !an) {
                        if (ax.is(":hidden") ? ao === "hide" : ao === "show") {
                            ax[ao]();
                            au()
                        } else { aq.call(ax[0], ar, au) }
                    } else {
                        if (ar.mode === "none") {
                            ax[ao]();
                            au()
                        } else { aq.call(ax[0], ar, av) }
                    }
                }
            ...
            show: (function(aj) {
                return function(al) {
                    if (ai(al)) { return aj.apply(this, arguments) } else {
            ...
            toggle: (function(aj) {
                return function(al) {
                    if (ai(al) || typeof al === "boolean") { return aj.apply(this, arguments) } else {
                        var ak = ah.apply(this, arguments);
                        ak.mode = "toggle";
                        return this.effect.call(this, ak)
                    }
            ...
            cssUnit: function(aj) {
                var ak = this.css(aj),
                    al = [];
                K.each(["em", "px", "%", "pt"], function(am, an) { if (ak.indexOf(an) > 0) { al = [parseFloat(ak), an] } });
                return al
            },
            cssClip: function(aj) { if (aj) { return this.css("clip", "rect(" + aj.top + "px " + aj.right + "px " + aj.bottom + "px " + aj.left + "px)") } return ag(this.css("clip"), this) },
            transfer: function(av, am) {
                var ao = K(this),
                    ...
                    aj = aq.offset(),
                    al = { top: aj.top - ar, left: aj.left - at, height: aq.innerHeight(), width: aq.innerWidth() },
                    an = ao.offset(),
                    ak = K("<div class='ui-effects-transfer'></div>").appendTo("body").addClass(av.className).css({ top: an.top - ar, left: an.left - at, height: ao.innerHeight(), width: ao.innerWidth(), position: au ? "fixed" : "absolute" }).animate(al, av.duration, av.easing, function() { ak.remove(); if (K.isFunction(am)) { am() } })
            }
        });
        ...
        function ag(ao, al) {
            ...
            return { top: parseFloat(aj[1]) || 0, right: aj[2] === "auto" ? an : parseFloat(aj[2]), bottom: aj[3] === "auto" ? am : parseFloat(aj[3]), left: parseFloat(aj[4]) || 0 }
        }
        K.fx.step.clip = function(aj) {
            if (!aj.clipInit) {
                aj.start = K(aj.elem).cssClip();
                if (typeof aj.end === "string") { aj.end = ag(aj.end, aj.elem) }
                aj.clipInit = true
            }
            K(aj.elem).cssClip({ top: aj.pos * (aj.end.top - aj.start.top) + aj.start.top, right: aj.pos * (aj.end.right - aj.start.right) + aj.start.right, bottom: aj.pos * (aj.end.bottom - aj.start.bottom) + aj.start.bottom, left: aj.pos * (aj.end.left - aj.start.left) + aj.start.left })
        }
    })();
    (function() {
        var ag = {};
        K.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(ai, ah) { ag[ah] = function(aj) { return Math.pow(aj, ai + 2) } });
        K.extend(ag, { Sine: function(ah) { return 1 - Math.cos(ah * Math.PI / 2) }, Circ: function(ah) { return 1 - Math.sqrt(1 - ah * ah) }, Elastic: function(ah) { return ah === 0 || ah === 1 ? ah : -Math.pow(2, 8 * (ah - 1)) * Math.sin(((ah - 1) * 80 - 7.5) * Math.PI / 15) }, Back: function(ah) { return ah * ah * (3 * ah - 2) }, Bounce: function(aj) { var ah, ai = 4; while (aj < ((ah = Math.pow(2, --ai)) - 1) / 11) {} return 1 / Math.pow(4, 3 - ai) - 7.5625 * Math.pow((ah * 3 - 2) / 22 - aj, 2) } });
        K.each(ag, function(ai, ah) {
            K.easing["easeIn" + ai] = ah;
            K.easing["easeOut" + ai] = function(aj) { return 1 - ah(1 - aj) };
            K.easing["easeInOut" + ai] = function(aj) { return aj < 0.5 ? ah(aj * 2) / 2 : 1 - ah(aj * -2 + 2) / 2 }
        })
    })();
    var W = K.effects;
    /*!
    ...
    var X = K.effects.define("blind", "hide", function(ai, ag) {
        var al = { up: ["bottom", "top"], vertical: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], horizontal: ["right", "left"], right: ["left", "right"] },
            aj = K(this),
            ak = ai.direction || "up",
            an = aj.cssClip(),
            ah = { clip: K.extend({}, an) },
        ...
        if (ai.mode === "show") {
            aj.cssClip(ah.clip);
            if (am) { am.css(K.effects.clipToBox(ah)) }
            ah.clip = an
        }
        if (am) { am.animate(K.effects.clipToBox(ah), ai.duration, ai.easing) }
        aj.animate(ah, { queue: false, duration: ai.duration, easing: ai.easing, complete: ag })
    });
    /*!
    ...
    var T = K.effects.define("bounce", function(ah, ao) {
        ...
        aw = ag.css(aj);
        if (!ai) { ai = ag[aj === "top" ? "outerHeight" : "outerWidth"]() / 3 }
        if (ax) {
            at = { opacity: 1 };
            at[aj] = aw;
            ag.css("opacity", 0).css(aj, ap ? -ai * 2 : ai * 2).animate(at, av, aq)
        }
        if (am) { ai = ai / Math.pow(2, al - 1) }
        at = {};
        at[aj] = aw;
        for (; au < al; au++) {
            ak = {};
    ...
    var Q = K.effects.define("clip", "hide", function(ao, ak) {
        var ah, ai = {},
            ...
            aj = am || an === "vertical";
        ah = al.cssClip();
        ai.clip = { top: aj ? (ah.bottom - ah.top) / 2 : ah.top, right: ag ? (ah.right - ah.left) / 2 : ah.right, bottom: aj ? (ah.bottom - ah.top) / 2 : ah.bottom, left: ag ? (ah.right - ah.left) / 2 : ah.left };
        K.effects.createPlaceholder(al);
        if (ao.mode === "show") {
            al.cssClip(ai.clip);
            ai.clip = ah
        }
        al.animate(ai, { queue: false, duration: ao.duration, easing: ao.easing, complete: ak })
    });
    /*!
    ...
    var G = K.effects.define("drop", "hide", function(aq, aj) {
        ...
        ak.animate(ai, { queue: false, duration: aq.duration, easing: aq.easing, complete: aj })
    });
    /*!
    ...
    var n = K.effects.define("explode", "hide", function(ah, au) {
        ...
        function az() { am.push(this); if (am.length === an * ai) { ak() } }
        for (ax = 0; ax < an; ax++) {
            ar = al.top + ax * at;
            ao = ax - (an - 1) / 2;
            for (aw = 0; aw < ai; aw++) {
                aj = al.left + aw * av;
                aq = aw - (ai - 1) / 2;
                ag.clone().appendTo("body").wrap("<div></div>").css({ position: "absolute", visibility: "visible", left: -aw * av, top: -ax * at }).parent().addClass("ui-effects-explode").css({ position: "absolute", overflow: "hidden", width: av, height: at, left: aj + (ay ? aq * av : 0), top: ar + (ay ? ao * at : 0), opacity: ay ? 0 : 1 }).animate({ left: aj + (ay ? 0 : aq * av), top: ar + (ay ? 0 : ao * at), opacity: ay ? 1 : 0 }, ah.duration || 500, ah.easing, az)
            }
        }
    ...
    var af = K.effects.define("fade", "toggle", function(ai, ah) {
        var ag = ai.mode === "show";
        K(this).css("opacity", ag ? 0 : 1).animate({ opacity: ag ? 1 : 0 }, { queue: false, duration: ai.duration, easing: ai.easing, complete: ah })
    });
    /*!
    ...
    var S = K.effects.define("fold", "hide", function(ax, al) {
        var am = K(this),
            ...
            ag = [ah[aj[0]], ah[aj[1]]],
            ai = am.queue().length;
        if (ap) { aw = parseInt(ap[1], 10) / 100 * ag[ao ? 0 : 1] }
        ar.clip[aj[0]] = aw;
        aq.clip[aj[0]] = aw;
        aq.clip[aj[1]] = 0;
        if (au) {
            am.cssClip(aq.clip);
            if (at) { at.css(K.effects.clipToBox(aq)) }
            aq.clip = ah
        }
        am.queue(function(ay) {
            if (at) { at.animate(K.effects.clipToBox(ar), ak, ax.easing).animate(K.effects.clipToBox(aq), ak, ax.easing) }
            ay()
    ...
    var b = K.effects.define("highlight", "show", function(ah, ag) {
        var ai = K(this),
            aj = { backgroundColor: ai.css("backgroundColor") };
        if (ah.mode === "hide") { aj.opacity = 0 }
        K.effects.saveStyle(ai);
        ai.css({ backgroundImage: "none", backgroundColor: ah.color || "#ffff99" }).animate(aj, { queue: false, duration: ah.duration, easing: ah.easing, complete: ag })
    });
    /*!
    ...
    var p = K.effects.define("size", function(aj, ap) {
        ...
        ao = { from: { y: ar.height / aq.height, x: ar.width / aq.width }, to: { y: ah.height / aq.height, x: ah.width / aq.width } };
        if (ay === "box" || ay === "both") {
        ...
        if (ay === "content" || ay === "both") {
            ...
            ag.find("*[width]").each(function() {
                var aC = K(this),
                    ...
                    aB = { height: az.height * ao.from.y, width: az.width * ao.from.x, outerHeight: az.outerHeight * ao.from.y, outerWidth: az.outerWidth * ao.from.x },
                    aA = { height: az.height * ao.to.y, width: az.width * ao.to.x, outerHeight: az.height * ao.to.y, outerWidth: az.width * ao.to.x };
                if (ao.from.y !== ao.to.y) {
                ...
                if (at) { K.effects.saveStyle(aC) }
                aC.css(aB);
                aC.animate(aA, aj.duration, aj.easing, function() { if (at) { K.effects.restoreStyle(aC) } })
            })
        }
        ag.animate(ah, {
            queue: false,
            ...
            complete: function() {
                var az = ag.offset();
                if (ah.opacity === 0) { ag.css("opacity", ar.opacity) }
                if (!at) {
    ...
    var f = K.effects.define("scale", function(ah, ag) {
        var ai = K(this),
            ...
            ak = K.extend(true, { from: K.effects.scaledDimensions(ai), to: K.effects.scaledDimensions(ai, aj, ah.direction || "both"), origin: ah.origin || ["middle", "center"] }, ah);
        if (ah.fade) {
            ak.from.opacity = 1;
            ak.to.opacity = 0
        }
    ...
    var h = K.effects.define("puff", "hide", function(ah, ag) {
        var ai = K.extend(true, {}, ah, { fade: true, percent: parseInt(ah.percent, 10) || 150 });
    ...
    var c = K.effects.define("pulsate", "show", function(ar, ai) {
        ...
        for (; aj < an; aj++) {
            ak.animate({ opacity: ao }, ah, ar.easing);
            ao = 1 - ao
        }
        ak.animate({ opacity: ao }, ah, ar.easing);
        ak.queue(ai);
    ...
    var D = K.effects.define("shake", function(av, an) {
        ...
        for (; ao < ah; ao++) { ap.animate(au, al, av.easing).animate(aq, al, av.easing) }
    ...
    var C = K.effects.define("slide", "show", function(ar, an) {
        var ak, ah, ao = K(this),
            ai = { up: ["bottom", "top"], down: ["top", "bottom"], left: ["right", "left"], right: ["left", "right"] },
            ap = ar.mode,
        ...
        ao.animate(am, { queue: false, duration: ar.duration, easing: ar.easing, complete: an })
    });
    /*!
     ...
     */
    var W;
    if (K.uiBackCompat !== false) { W = K.effects.define("transfer", function(ah, ag) { K(this).transfer(ah, ag) }) }
    var g = W
}));
/*! jQuery Timepicker Addon - v1.6.3 - 2016-04-20
 * http://trentrichardson.com/examples/timepicker
 * Copyright (c) 2016 Trent Richardson; Licensed MIT */
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery", "jquery-ui"], a) } else { a(jQuery) } }(function($) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        _newInst: function($input, opts) {
            var tp_inst = new Timepicker(),
                ...
                fns = {},
                overrides, i;
            for (var attrName in this._defaults) { if (this._defaults.hasOwnProperty(attrName)) { var attrValue = $input.attr("time:" + attrName); if (attrValue) { try { inlineSettings[attrName] = eval(attrValue) } catch (err) { inlineSettings[attrName] = attrValue } } } }
            overrides = { beforeShow: function(input, dp_inst) { if ($.isFunction(tp_inst._defaults.evnts.beforeShow)) { return tp_inst._defaults.evnts.beforeShow.call($input[0], input, dp_inst, tp_inst) } }, onChangeMonthYear: function(year, month, dp_inst) { if ($.isFunction(tp_inst._defaults.evnts.onChangeMonthYear)) { tp_inst._defaults.evnts.onChangeMonthYear.call($input[0], year, month, dp_inst, tp_inst) } }, onClose: function(dateText, dp_inst) { if (tp_inst.timeDefined === true && $input.val() !== "") { tp_inst._updateDateTime(dp_inst) } if ($.isFunction(tp_inst._defaults.evnts.onClose)) { tp_inst._defaults.evnts.onClose.call($input[0], dateText, dp_inst, tp_inst) } } };
            ...
            if (tp_inst._defaults.timezoneList !== null) { timezoneList = tp_inst._defaults.timezoneList }
            ...
            tp_inst.ampm = "";
            tp_inst.$input = $input;
            if (tp_inst._defaults.altField) { tp_inst.$altInput = $(tp_inst._defaults.altField); if (tp_inst._defaults.altRedirectFocus === true) { tp_inst.$altInput.css({ cursor: "pointer" }).focus(function() { $input.trigger("focus") }) } }
        ...
        _afterInject: function() { var o = this.inst.settings; if ($.isFunction(o.afterInject)) { o.afterInject.call(this) } },
                    ...
                    if (show && o[litem + "Grid"] > 0) {
                        ...
                        $tp.find(".ui_tpicker_" + litem + " table").css({ width: size + "%", marginLeft: o.isRTL ? "0" : ((size / (-2 * gridSize[litem])) + "%"), marginRight: o.isRTL ? ((size / (-2 * gridSize[litem])) + "%") : "0", borderCollapse: "collapse" }).find("td").click(function(e) {
                            var $t = $(this),
                                ...
                                ap = h.replace(/[^apm]/ig),
                                f = $t.data("for");
                            if (f === "hour") { if (ap.indexOf("p") !== -1 && n < 12) { n += 12 } else { if (ap.indexOf("a") !== -1 && n === 12) { n = 0 } } }
        ...
        _limitMinMaxDateTime: function(dp_inst, adjustSliders) {
            ...
            if (dp_inst.settings.minTime !== null) {
                ...
                if (this.hour < tempMinTime.getHours()) {
                    ...
                    if (this.hour === tempMinTime.getHours() && this.minute < tempMinTime.getMinutes()) { this.minute = this._defaults.minuteMin = tempMinTime.getMinutes() } else {
                        if (this._defaults.hourMin < tempMinTime.getHours()) {
                            this._defaults.hourMin = tempMinTime.getHours();
                            this._defaults.minuteMin = tempMinTime.getMinutes()
                        } else { if (this._defaults.hourMin === tempMinTime.getHours() === this.hour && this._defaults.minuteMin < tempMinTime.getMinutes()) { this._defaults.minuteMin = tempMinTime.getMinutes() } else { this._defaults.minuteMin = 0 } }
                    }
                }
            }
            if (dp_inst.settings.maxTime !== null) {
                ...
                if (this.hour > tempMaxTime.getHours()) {
                    ...
                    if (this.hour === tempMaxTime.getHours() && this.minute > tempMaxTime.getMinutes()) { this.minute = this._defaults.minuteMax = tempMaxTime.getMinutes() } else {
                        if (this._defaults.hourMax > tempMaxTime.getHours()) {
                            this._defaults.hourMax = tempMaxTime.getHours();
                            this._defaults.minuteMax = tempMaxTime.getMinutes()
                        } else { if (this._defaults.hourMax === tempMaxTime.getHours() === this.hour && this._defaults.minuteMax > tempMaxTime.getMinutes()) { this._defaults.minuteMax = tempMaxTime.getMinutes() } else { this._defaults.minuteMax = 59 } }
                    }
                }
            }
        ...
        _onTimeChange: function() {
            ...
            if (this.$timeObj) { if (pickerTimeFormat === o.timeFormat) { this.$timeObj.val(this.formattedTime + pickerTimeSuffix) } else { this.$timeObj.val($.datepicker.formatTime(pickerTimeFormat, this, o) + pickerTimeSuffix) } if (this.$timeObj[0].setSelectionRange) { var sPos = this.$timeObj[0].selectionStart; var ePos = this.$timeObj[0].selectionEnd } }
            ...
            if (!this._defaults.showTimepicker) { this.$input.val(this.formattedDate) } else {
                if (this.$altInput && this._defaults.timeOnly === false && this._defaults.altFieldTimeOnly === true) {
                    ...
                    if (this.$altInput) {
                        ...
                        if (!this._defaults.timeOnly) { if (this._defaults.altFormat) { altFormattedDateTime = $.datepicker.formatDate(this._defaults.altFormat, (dt === null ? new Date() : dt), formatCfg) } else { altFormattedDateTime = this.formattedDate } if (altFormattedDateTime) { altFormattedDateTime += altSeparator } }
            ...
            slider: {
                ...
                options: function(tp_inst, obj, unit, opts, val) {
                    if (tp_inst._defaults.isRTL) {
                        if (typeof(opts) === "string") { if (opts === "min" || opts === "max") { if (val !== undefined) { return obj.slider(opts, val * -1) } return Math.abs(obj.slider(opts)) } return obj.slider(opts) }
                        var min = opts.min,
                            max = opts.max;
            ...
            select: {
                create: function(tp_inst, obj, unit, val, min, max, step) {
                    ...
                    for (var i = min; i <= max; i += step) {
                        ...
                        if (unit === "hour") { sel += $.datepicker.formatTime($.trim(format.replace(/[^ht ]/ig, "")), { hour: i }, tp_inst._defaults) } else { if (unit === "millisec" || unit === "microsec" || i >= 10) { sel += i } else { sel += "0" + i.toString() } }
                        sel += "</option>"
                    }
                    sel += "</select>";
    ...
    $.fn.extend({
        timepicker: function(o) { o = o || {}; var tmp_args = Array.prototype.slice.call(arguments); if (typeof o === "object") { tmp_args[0] = $.extend(o, { timeOnly: true }) } return $(this).each(function() { $.fn.datetimepicker.apply($(this), tmp_args) }) },
        datetimepicker: function(o) {
            o = o || {};
            var tmp_args = arguments;
            if (typeof(o) === "string") {
                if (o === "getDate" || (o === "option" && tmp_args.length === 2 && typeof(tmp_args[1]) === "string")) { return $.fn.datepicker.apply($(this[0]), tmp_args) } else {
                    return this.each(function() {
                        var $t = $(this);
        ...
        var strictParse = function(f, s, o) {
            ...
            var getFormatPositions = function(timeFormat) {
                var finds = timeFormat.toLowerCase().match(/(h{1,2}|m{1,2}|s{1,2}|l{1}|c{1}|t{1,2}|z|'.*?')/g),
                    orders = { h: -1, m: -1, s: -1, l: -1, c: -1, t: -1, z: -1 };
    ...
    $.datepicker._getDateDatepicker = function(target, noDefault) {
        ...
        if (tp_inst) {
            ...
            var currDT = null;
            if (tp_inst.$altInput && tp_inst._defaults.altFieldTimeOnly) { currDT = tp_inst.$input.val() + " " + tp_inst.$altInput.val() } else { if (tp_inst.$input.get(0).tagName !== "INPUT" && tp_inst.$altInput) { currDT = tp_inst.$altInput.val() } else { currDT = tp_inst.$input.val() } }
    ...
    $.datepicker.parseDate = function(format, value, settings) {
        var date;
        try { date = this._base_parseDate(format, value, settings) } catch (err) {
            if (err.indexOf(":") >= 0) {
    ...
    $.datepicker._optionDatepicker = function(target, name, value) {
        ...
        if (tp_inst) {
            ...
            if (typeof name === "string") {
                if (name === "minDate" || name === "minDateTime") { min = value } else {
                    if (name === "maxDate" || name === "maxDateTime") { max = value } else {
                        if (name === "onSelect") { onselect = value } else {
            ...
            } else { if (typeof name === "object") { if (name.minDate) { min = name.minDate } else { if (name.minDateTime) { min = name.minDateTime } else { if (name.maxDate) { max = name.maxDate } else { if (name.maxDateTime) { max = name.maxDateTime } } } } for (prop in overrides) { if (overrides.hasOwnProperty(prop) && name[prop]) { fns[prop] = name[prop] } } } }
            for (prop in fns) {
    ...
    var isEmptyObject = function(obj) { var prop; for (prop in obj) { if (obj.hasOwnProperty(prop)) { return false } } return true };
    var extendRemove = function(target, props) { $.extend(target, props); for (var name in props) { if (props[name] === null || props[name] === undefined) { target[name] = props[name] } } return target };
    var detectSupport = function(timeFormat) {
        var tf = timeFormat.replace(/'.*?'/g, "").toLowerCase(),
            isIn = function(f, t) { return f.indexOf(t) !== -1 ? true : false };
    ...
    var convert24to12 = function(hour) { hour %= 12; if (hour === 0) { hour = 12 } return String(hour) };
    var computeEffectiveSetting = function(settings, property) { return settings && settings[property] ? settings[property] : $.timepicker._defaults[property] };
    ...
    $.timepicker.handleRange = function(method, startTime, endTime, options) {
        ...
        function checkDates(changed, other) {
            ...
            if (startdt !== null) {
                ...
                if (options.minInterval > 0 && minDate > enddt) { endTime[method]("setDate", minDate) } else { if (options.maxInterval > 0 && maxDate < enddt) { endTime[method]("setDate", maxDate) } else { if (startdt > enddt) { other[method]("setDate", changeddt) } } }
            }
        }
...
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a("object" == typeof exports ? require("jquery") : jQuery) }(function(e) {
    ...
    e.mask = { definitions: { "9": "[0-9]", a: "[A-Za-z]", "*": "[A-Za-z0-9]" }, autoclear: !0, dataName: "rawMaskFn", placeholder: "_" }, e.fn.extend({
        caret: function(i, g) { var h; if (0 !== this.length && !this.is(":hidden")) { return "number" == typeof i ? (g = "number" == typeof g ? g : i, this.each(function() { this.setSelectionRange ? this.setSelectionRange(i, g) : this.createTextRange && (h = this.createTextRange(), h.collapse(!0), h.moveEnd("character", g), h.moveStart("character", i), h.select()) })) : (this[0].setSelectionRange ? (i = this[0].selectionStart, g = this[0].selectionEnd) : document.selection && document.selection.createRange && (h = document.selection.createRange(), i = 0 - h.duplicate().moveStart("character", -100000), g = i + h.text.length), { begin: i, end: g }) } },
        unmask: function() { return this.trigger("unmask") },
        mask: function(q, j) {
            var n, k, h, i, p, g, l, o;
            if (!q && this.length > 0) { n = e(this[0]); var m = n.data(e.mask.dataName); return m ? m() : void 0 }
            return j = e.extend({ autoclear: e.mask.autoclear, placeholder: e.mask.placeholder, completed: null }, j), k = e.mask.definitions, h = [], i = l = q.length, p = null, e.each(q.split(""), function(r, s) { "?" == s ? (l--, i = r) : k[s] ? (h.push(new RegExp(k[s])), null === p && (p = h.length - 1), i > r && (g = h.length - 1)) : h.push(null) }), this.trigger("unmask").each(function() {
                function r() {
                    if (j.completed) {
                        for (var I = p; g >= I; I++) { if (h[I] && w[I] === E(I)) { return } }
                        j.completed.call(F)
                    }
                }

                function E(I) { return j.placeholder.charAt(I < j.placeholder.length ? I : 0) }

                function D(I) { for (; ++I < l && !h[I];) {} return I }

                function y(I) { for (; --I >= 0 && !h[I];) {} return I }
                ...
                function s(M) {
                    ...
                    for (K = M, L = E(M); l > K; K++) {
                        if (h[K]) {
                            if (I = D(K), J = w[K], w[K] = L, !(l > I && h[I].test(J))) { break }
                            L = J
                        }
                    }
                }
                ...
                function A() {
                    var J = F.val(),
                        K = F.caret();
                    var I = function() { e.proxy(e.fn.caret, F, K.begin, K.begin)() };
                    if (o && o.length && o.length > J.length) {
                        for (u(!0); K.begin > 0 && !h[K.begin - 1];) { K.begin-- }
                        if (0 === K.begin) { for (; K.begin < p && !h[K.begin];) { K.begin++ } }
                        setTimeout(function() {
                            I();
                            r()
                        }, 0)
                    } else {
                        for (u(!0); K.begin < l && !h[K.begin];) { K.begin++ }
                        setTimeout(function() {
                            I();
                            r()
                        }, 0)
                        ...
                        if (!(M.ctrlKey || M.altKey || M.metaKey || 32 > I || (I > 34 && I < 41)) && I && 13 !== I) {
                            if (N.end - N.begin !== 0 && (t(N.begin, N.end), v(N.begin, N.end - 1)), L = D(N.begin - 1), l > L && (O = String.fromCharCode(I), h[L].test(O))) {
                                if (s(L), w[L] = O, C(), K = D(L), b) {
                                    var J = function() { e.proxy(e.fn.caret, F, K)() };
                                    setTimeout(J, 0)
                                } else { F.caret(K) }
                                N.begin <= g && r()
                            }
                ...
                function t(K, I) { var J; for (J = K; I > J && l > J; J++) { h[J] && (w[J] = E(J)) } }

                function C() { F.val(w.join("")) }

                function u(J) {
                    var I, N, M, L = F.val(),
                        K = -1;
                    for (I = 0, M = 0; l > I; I++) { if (h[I]) { for (w[I] = E(I); M++ < L.length;) { if (N = L.charAt(M - 1), h[I].test(N)) { w[I] = N, K = I; break } } if (M > L.length) { t(I + 1, l); break } } else { w[I] === L.charAt(M) && M++, i > I && (K = I) } }
                    return J ? C() : i > K + 1 ? j.autoclear || w.join("") === B ? (F.val() && F.val(""), t(0, l)) : C() : (C(), F.val(F.val().substring(0, K + 1))), i ? I : p
                }
                var F = e(this),
                    w = e.map(q.split(""), function(J, I) { return "?" != J ? k[J] ? E(I) : J : void 0 }),
                    B = w.join(""),
                    H = F.val();
                F.data(e.mask.dataName, function() { return e.map(w, function(J, I) { return h[I] && J != E(I) ? J : null }).join("") }), F.one("unmask", function() { F.off(".mask").removeData(e.mask.dataName) }).on("focus.mask", function() {
                    if (!F.prop("readonly")) {
                        clearTimeout(f);
                        var I;
                        H = F.val(), I = u(), f = setTimeout(function() { F.get(0) === document.activeElement && (C(), I == q.replace("?", "").length ? F.caret(0, I) : F.caret(I)) }, 10)
                    }
...
$(function() {
    var a = {
        ...
        simulator: $('<div id="textarea_simulator"/>').css({ position: "absolute", top: 0, left: 0, visibility: "hidden" }).appendTo(document.body),
        toHtml: function(b) { return PrimeFaces.escapeHTML(b).replace(/\n/g, "<br>").split(" ").join('<span style="white-space:prev-wrap">&nbsp;</span>') },
    ...
    $.fn.extend({
        ...
        cloneStyle: function(c, b) { var d = this.getComputedStyle(b); if (!!d) { $(c).css(b, d) } },
        ...
        getCursorPosition: function() {
            var e = this[0],
                b = 0;
            if ("selectionStart" in e) { b = e.selectionStart } else {
                if ("selection" in document) {
                    ...
                    if (parseInt($.browser.version) > 6) {
                        ...
                        for (; h.compareEndPoints("StartToStart", c) < 0; b++) { h.moveStart("character", 1) }
                        for (var d = 0; d <= b; d++) { if (e.value.charAt(d) == "\n") { b++ } }
                        var f = e.value.split("\n").length - 1;
                        b -= f;
                        return b
                    }
...
*/
(function(c, a) {
    if (typeof define === "function" && define.amd) { define(["exports", "module"], a) } else {
        if (typeof exports !== "undefined" && typeof module !== "undefined") { a(exports, module) } else {
            var b = { exports: {} };
            a(b.exports, b);
    ...
    function b(l) {
        ...
        if (!l || !l.nodeName || l.nodeName !== "TEXTAREA" || l.hasAttribute("data-autosize-on")) { return }
        var h = null;
        var j = "hidden";

        function s() {
            var t = window.getComputedStyle(l, null);
            if (t.resize === "vertical") { l.style.resize = "none" } else { if (t.resize === "both") { l.style.resize = "horizontal" } }
            if (t.boxSizing === "content-box") { h = -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) } else { h = parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth) }
            i()
        }
        ...
        function i() {
            ...
            if (PrimeFaces.env.isIE(10) || PrimeFaces.env.isIE(9)) { var C = (!l.rows ? 1 : l.rows); var x = a(l); var A = (x * C) + h; if (v < A) { v = A } }
            if (l.scrollHeight === 0) { l.style.height = w; return }
            l.style.height = v + "px";
            document.documentElement.scrollTop = u;
            document.body.scrollTop = z;
            var t = window.getComputedStyle(l, null);
            if (t.height !== l.style.height) { if (j !== "visible") { n("visible"); return } } else { if (j !== "hidden") { n("hidden"); return } }
            if (B !== l.style.height) {
        ...
        var r = (function(t) {
            ...
            Object.keys(t).forEach(function(u) { l.style[u] = t[u] })
        }).bind(l, { height: l.style.height, resize: l.style.resize, overflowY: l.style.overflowY, overflowX: l.style.overflowX, wordWrap: l.style.wordWrap });
        l.addEventListener("autosize:destroy", r);
        if ("onpropertychange" in l && "oninput" in l) { l.addEventListener("keyup", i) }
        window.addEventListener("resize", i);
        l.addEventListener("input", i);
        l.addEventListener("autosize:update", i);
        l.setAttribute("data-autosize-on", true);
        if (p) { l.style.overflowY = "hidden" }
        if (q) {
    ...
    function e(i) {
        if (!(i && i.nodeName && i.nodeName === "TEXTAREA")) { return }
    ...
    if (typeof window === "undefined" || typeof window.getComputedStyle !== "function") {
        d = function(h) { return h };
        d.destroy = function(h) { return h };
        d.update = function(h) { return h }
    } else {
        d = function(i, h) { if (i) { Array.prototype.forEach.call(i.length ? i : [i], function(j) { return b(j, h) }) } return i };
        d.destroy = function(h) { if (h) { Array.prototype.forEach.call(h.length ? h : [h], e) } return h };
        d.update = function(h) { if (h) { Array.prototype.forEach.call(h.length ? h : [h], g) } return h }
    }
    f.exports = d
});
/*!
 ...
 * Released under the MIT license
 */
(function(a) { if (typeof define === "function" && define.amd) { define(["jquery"], a) } else { if (typeof exports === "object") { module.exports = a(require("jquery")) } else { a(jQuery) } } }(function(f) {
    var a = /\+/g;
...
(function(d) {
    ...
    d.event.special.mousewheel = { setup: function() { if (this.addEventListener) { for (var e = b.length; e;) { this.addEventListener(b[--e], c, false) } } else { this.onmousewheel = c } }, teardown: function() { if (this.removeEventListener) { for (var e = b.length; e;) { this.removeEventListener(b[--e], c, false) } } else { this.onmousewheel = null } } };
    d.fn.extend({ mousewheel: function(e) { return e ? this.bind("mousewheel", e) : this.trigger("mousewheel") }, unmousewheel: function(e) { return this.unbind("mousewheel", e) } });
...
(function(c) {
    ...
    c(document).ready(function() {
        ...
        if (k(t, "selectionStart") && k(t, "selectionEnd")) {
            ...
            p = function(w, v) { if (v) { w.selectionEnd = w.selectionStart } else { w.selectionStart = w.selectionEnd } }
        } else {
            if (j(t, "createTextRange") && e(document, "selection") && j(document.selection, "createRange")) {
                d = function(z) {
                    ...
                    if (y && y.parentElement() == z) {
                        ...
                        A = z.createTextRange();
                        A.collapse(false);
                        if (w.compareEndPoints("StartToEnd", A) > -1) { C = x = v } else {
                            C = -w.moveStart("character", -v);
                            C += B.slice(0, C).split("\n").length - 1;
                            if (w.compareEndPoints("EndToEnd", A) > -1) { x = v } else {
                ...
                g = function(z, v, y) {
                    ...
                    var w = u(z, A.start);
                    x.collapse(true);
                    if (A.start == A.end) { x.move("character", w) } else {
...
(function(b) {
    ...
    function e(h, i) {
        if (h.originalEvent.touches.length > 1) { return }
        h.preventDefault();
    ...
    d._touchStart = function(h) {
        var g = this;
        if (a || !g._mouseCapture(h.originalEvent.changedTouches[0])) { return }
        a = true;
        g._touchMoved = 0;
        e(h, "mouseover");
        e(h, "mousemove");
    ...
    d._touchEnd = function(g) {
        ...
        e(g, "mouseup");
        e(g, "mouseout");
        if (this._touchMoved <= 5) { e(g, "click") }
        a = false
    };
    d._mouseInit = function() {
        var g = this;
        g.element.bind({ touchstart: b.proxy(g, "_touchStart"), touchmove: b.proxy(g, "_touchMove"), touchend: b.proxy(g, "_touchEnd") });
        f.call(g)
    };
    d._mouseDestroy = function() {
        var g = this;
        g.element.unbind({ touchstart: b.proxy(g, "_touchStart"), touchmove: b.proxy(g, "_touchMove"), touchend: b.proxy(g, "_touchEnd") });
        c.call(g)
    }
})(jQuery);
(function() {
    ...
    $.datepicker._attachHandlers = function(c) {
        ...
        c.dpDiv.find("[data-handler]").map(function() {
            var e = {
                ...
                selectDay: function() { $.datepicker._selectDay(d, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this); return false },
                selectMonth: function() { $.datepicker._selectMonthYear(d, this, "M"); return false },
                selectYear: function() { $.datepicker._selectMonthYear(d, this, "Y"); return false }
            };
            ...
            this.updateDatePickerPosition = function(g) {
                ...
                var i = { left: $.datepicker._pos[0], top: $.datepicker._pos[1] };
                $.datepicker._pos = null;
                var h = false;
                $(g.input[0]).parents().each(function() { h |= $(this).css("position") === "fixed"; return !h });
                var f = $.datepicker._checkOffset(g, i, h);
                g.dpDiv.css({ top: f.top + "px" })
            }
        })
    };
    $.datepicker._generateMonthYearHeader = function(f, d, n, h, l, o, j, b) {
        var s, c, t, q, g, p, m, i, e = this._get(f, "changeMonth"),
            ...
            r = "";
        if (o || !e) { r += "<span class='ui-datepicker-month' aria-label='select month'>" + j[d] + "</span>" } else {
            s = (h && h.getFullYear() === n);
            c = (l && l.getFullYear() === n);
            r += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change' aria-label='select month'>";
            for (t = 0; t < 12; t++) { if ((!s || t >= h.getMonth()) && (!c || t <= l.getMonth())) { r += "<option value='" + t + "'" + (t === d ? " selected='selected'" : "") + ">" + b[t] + "</option>" } }
            r += "</select>"
        }
        if (!v) { k += r + (o || !(e && u) ? "&#xa0;" : "") }
        if (!f.yearshtml) {
            f.yearshtml = "";
            if (o || !u) { k += "<span class='ui-datepicker-year' aria-label='select year'>" + n + "</span>" } else {
                ...
                for (; m <= i; m++) { f.yearshtml += "<option value='" + m + "'" + (m === n ? " selected='selected'" : "") + ">" + m + "</option>" }
                f.yearshtml += "</select>";
                k += f.yearshtml;
                f.yearshtml = null
            }
...
(function() {
    $.extend($.ui.keyCode, { NUMPAD_ENTER: 108 });
    $.fn.extend({
        focus: (function(a) {
            return function(b, c) {
                return typeof b === "number" ? this.each(function() {
                    var d = this;
                    setTimeout(function() { $(d).focus(); if (c) { c.call(d) } }, b)
                }) : a.apply(this, arguments)
            }
        })($.fn.focus),
        disableSelection: (function() { var a = "onselectstart" in document.createElement("div") ? "selectstart" : "mousedown"; return function() { return this.bind(a + ".ui-disableSelection", function(b) { b.preventDefault() }) } })(),
        enableSelection: function() { return this.unbind(".ui-disableSelection") },
        zIndex: function(d) {
            if (d !== undefined) { return this.css("zIndex", d) }
            if (this.length) {
                var b = $(this[0]),
                    a, c;
                while (b.length && b[0] !== document) {
                    a = b.css("position");
                    if (a === "absolute" || a === "relative" || a === "fixed") { c = parseInt(b.css("zIndex"), 10); if (!isNaN(c) && c !== 0) { return c } }
                    b = b.parent()
                }
            }
            return 0
            ...
            slider: {
                create: function(b, g, e, h, c, a, d) {
                    ...
                    return g.prop("slide", null).slider({
                        ...
                        stop: function(i, j) { b._onSelectHandler() }
                    })
                },
                options: function(b, f, e, d, g) {
                    if (b._defaults.isRTL) {
                        if (typeof(d) === "string") { if (d === "min" || d === "max") { if (g !== undefined) { return f.slider(d, g * -1) } return Math.abs(f.slider(d)) } return f.slider(d) }
                        var c = d.min,
                            a = d.max;
                        d.min = d.max = null;
                        if (c !== undefined) { d.max = c * -1 }
                        if (a !== undefined) { d.min = a * -1 }
                        return f.slider(d)
                    }
                    if (typeof(d) === "string" && g !== undefined) { return f.slider(d, g) }
                    return f.slider(d)
                },
                value: function(a, c, b, d) { if (a._defaults.isRTL) { if (d !== undefined) { return c.slider("value", d * -1) } return Math.abs(c.slider("value")) } if (d !== undefined) { return c.slider("value", d) } return c.slider("value") }
            },
            select: {
                create: function(g, f, k, b, d, h, c) {
                    ...
                    for (var e = d; e <= h; e += c) {
                        ...
                        if (k === "hour") { a += $.datepicker.formatTime($.trim(j.replace(/[^ht ]/ig, "")), { hour: e }, g._defaults) } else { if (k === "millisec" || k === "microsec" || e >= 10) { a += e } else { a += "0" + e.toString() } }
                        a += "</option>"
                    }
                    a += "</select>";
                ...
                options: function(a, d, c, b, f) {
                    var e = {},
                        g = d.children("select");
                    if (typeof(b) === "string") {
                        if (f === undefined) { return g.data(b) }
                        e[b] = f
                    } else { e = b }
                    return a.control.create(a, d, g.data("unit"), g.val(), e.min >= 0 ? e.min : g.data("min"), e.max || g.data("max"), e.step || g.data("step"))
                },
                value: function(a, c, b, d) { var e = c.children("select"); if (d !== undefined) { return e.val(d) } return e.val() }
            }
        }
    })
})();
...
$(document).on("pfAjaxSend", function(a, b, c) { c && c.data && c.source && (a = $("string" == typeof c.source ? document.getElementById(c.source) : c.source), a.is("select, button, a, .ui-selectcheckboxmenu-multiple") && ($("html").addClass("progress").data("triggeredByChangeEvent", -1 < c.data.indexOf("javax.faces.partial.event\x3dchange")), a.addClass("progress"))) }).on("pfAjaxSuccess", function() { $("html").hasClass("progress") && !$("html").data("triggeredByChangeEvent") && PrimeFaces.ajax.Queue.abortAll() }).on("pfAjaxComplete",
    function(a, b, c) {
        a = $("body").hasClass("templatebackend");
        b && b.pfArgs && b.pfArgs.validationFailed && (a && !PF("growl").jq.children().length && PF("growl").renderMessage({ severity: "error", summary: "Validation has failed" }), b = $(".inputErrors:first").closest(".inputRegion"), b.length && b.offset().top < $(window).scrollTop() && mtw.scrollTo(b));
...
$(document).on("click", "[data-copy-target]", function() {
    var a = $(this),
        b = $(document.getElementById(a.data("copy-target"))),
    ...
    try {
        ...
        var f = $.trim(a.text());
        f && (a.text("Copied!"), setTimeout(function() { a.text(f) }, 3E3));
        PF("growl").renderMessage({ severity: "info", summary: "Copied!" })
    } catch (g) {
        PF("growl").renderMessage({
            severity: "warn",
            summary: "Unable to copy, please try again."
        })
    } finally { b.removeAllRanges(), document.body.removeChild(c) }
});
$(document).on("click", ".js-dualbutton", function(a) {
    a.stopPropagation();
    a.preventDefault();
    var b = $(this).parent().find(".r_button__submenu");
    $(".r_button__submenu").not(b).each(function() { $(this).hide() });
    b.toggle();
    $(document).one("click touchstart", function(a) { $(a.target).hasClass("js-dualbutton") || $(a.target).closest(".r_button__submenu").length || b.is(":visible") && b.hide() })
});
$(window).scroll(function() {
    var a = $(this).scrollTop();
    $("body").toggleClass("scrolled", !!a);
    var b = $("nav.bar.override");
    b.length && 708 < $(window).width() && (500 > a ? b.css("display", "none") : b.css("display", "flex"));
    var b = $("#header nav.bar"),
        c = a + b.height() + ($(".devheader").height() || 0),
        a = $(".r_footer, .securefooter").first(),
        e = a.length ? a.offset().top : 0;
    $(".fixed-on-scroll").each(function(a, b) {
        a = $(b);
        var d = a.data("offsetTop");
        b = c + a.height();
        d || (d = a.offset().top, a.data("offsetTop", d));
        c > d ? (d = c - d, b > e && (d -=
            b - e), a.css("margin-top", d + "px")) : a.css("margin-top", "")
    })
});
$(document).on("click touchstart", ".js-tooltip-button", function() { $(document).one("click touchstart", function(a) { $(".ui-tooltip").css("display", "none") }) });
$(document).on("keyup", ".inputRegion.withRemainingChars :input[maxlength]:not([readonly])", function() {
    var a = $(this),
        b = a.closest(".inputRegion").find(".remainingChars"),
        a = a.attr("maxlength") - a.val().replace(/([\r])?\n/g, "\r\n").length;
    b.text(a)
});
$(document).on("focus", ".inputRegion input", function() { $(this).closest(".inputRegion").find(".inputfieldinfo").slideDown("fast") });
$(document).on("click", "a.popup", function(a) {
...
$(document).on("click", ".tutorapplication__iconlist.accordion li h4", function() {
    $li = $(this).parent();
    $(this).next("section").slideToggle(function() { $li.toggleClass("open") })
});
$(document).on("click", ".ui-selectonemenu-panel .ui-selectonemenu-close", function(a) {
    a.preventDefault();
    a.stopPropagation();
    a = $(this);
    PF("widget_" + a.closest(".ui-selectonemenu-panel").attr("id").replace(/_panel/, "").replace(/:/g, "_")).hide()
});
$(document).on("click", "#vTF .ui-selectonemenu-panel .ui-selectonemenu-items a", function(a) {
    if (window.run) {
        a.preventDefault();
        a.stopPropagation();
        var b = $(this);
        ...
        run([{ name: "command", value: "updateViewTutors" }, { name: "name", value: a }, { name: "value", value: b }])
    }
});
$(document).on("click", ".js-truncate-button", function() {
    var a = $(this),
        b = a.closest(".js-truncate");
    b.find(".js-truncate-short").toggle();
    b.find(".js-truncate-long").toggle();
    var c = a.text(),
        e = b.data("showlabel"),
        b = b.data("hidelabel");
    a.toggleClass("link__more--open").text(c == b ? e : b)
});
$(document).on("click", "a[href^\x3d'#']", function(a) { a = $(this); if (!a.closest(".ui-tabs-nav").length && (a = a.attr("href")) && 1 < a.length) { var b = $(document.getElementById(a.substring(1))); if (b.length) return $("html, body").animate({ scrollTop: b.offset().top - 80 }, "slow", function() { b.effect("highlight") }), !1 } });
$(document).on("click", "#bookingsDrawerTrigger", function() {
    var a = $(this),
        b = $("#bookingsDrawer"),
        c = $("#bookingsDrawerUnread");
    a.toggleClass("tutorcard__bookings__trigger--open");
    b.slideToggle(function() {
        b.toggleClass("tutorcard__bookings__content--open").hasClass("tutorcard__bookings__content--open") || b.find(".tile__status.important").removeClass("important");
        c.empty()
    })
});
$(document).on("mouseenter", ".tiles__table tr[class*\x3d'recurrence-']", function() {
    $(".tiles__table tr.ui-state-highlight").removeClass("ui-state-highlight");
    var a = $(this).attr("class").match(/recurrence-[\w-]*\b/);
    $(".tiles__table tr." + a).addClass("ui-state-highlight")
}).on("mouseleave", ".tiles__table tr[class*\x3d'recurrence-']", function() { $(".tiles__table tr.ui-state-highlight").removeClass("ui-state-highlight") });
$(document).on("click", "dl.container__accordion dt", function() { $(this).toggleClass("open") });
$(document).on("click", "body.ui-datepicker-open .ui-datepicker", function(a) { a.offsetX >= $(this).width() - 25 && 55 >= a.offsetY && $.datepicker._hideDatepicker() });
$(document).on("click", ".js-navbar__showpopovermenuonclick", function() { $(this).toggleClass("open").next(".popover__menu").slideToggle() });